...
def find_end(data, start, limit=0x1000):
...
print("table 0x5E", hex(load_u32(data, 0x800910A0 + 0x5E * 4)))
print("table 0x77", hex(load_u32(data, 0x800910A0 + 0x77 * 4)))
print("table 0x9B", hex(load_u32(data, 0x800910A0 + 0x9B * 4)))

for name, start in [("14694", 0x80014694), ("14DA0", 0x80014DA0)]:
