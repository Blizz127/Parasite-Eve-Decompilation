#!/usr/bin/env bash
# Phase 5AN: Disc 1 rebuild with thirty-seven C leaves
# (17E9C, 19050, 19058, 190AC, 190B4, 3D82C, 3DFC8, 50D18, 527C0, 5BCA8, 8CA7C, 8F694, 8F6A8, 8F868, 8F880, 8FCB4, 904A0, 904AC, 904B4, 904BC, 906B4, 90A0C, 90C38, 90C4C, 90C60, 90C74, 90F54, C2B40, C8268, C9260, C9EA0, CACD4, CD2DC, CD2E4, CD59C, CDD04, CE3AC).
#
...
# Phase 5AN file-span sizes (config subsegment edges; exclusive end).
...
/* Phase 5AN ROM-order link script (thirty-seven C leaves).
...
echo
echo "=== Summary ==="
echo "Assemble: OK (27 asm units)"
echo "Compile:  OK (thirty-seven C leaves with Phase 4J flags)"
...
if [[ "$cmp_ec" -eq 0 ]]; then
    ...
    echo "Matching claim: YES (thirty-seven C leaves + remaining asm)"
