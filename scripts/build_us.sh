...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/96E0.s.o asm/disc1/96E0.s
...
python3 "$TRIM" build/asm/disc1/96E0.s.o .text "$SIZE_96E0"
...
SECTIONS
{
    ...
    .main 0x80010000 : AT(0x800)
    {
        ...
        build/asm/disc1/96E0.s.o(.rodata)
