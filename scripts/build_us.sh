...
# Phase 5BC file-span sizes (config subsegment edges; exclusive end).
...
/* Phase 5BC ROM-order link script (fifty-two C leaves).
...
echo
echo "=== Summary ==="
echo "Assemble: OK (45 asm units)"
echo "Compile:  OK (fifty-two C leaves with Phase 4J flags; func_80051E48 -fno-delayed-branch)"
...
if [[ "$cmp_ec" -eq 0 ]]; then
    ...
    echo "Matching claim: YES (fifty-two C leaves + remaining asm)"
