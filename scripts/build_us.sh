...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/970C.s.o asm/disc1/970C.s
...
python3 "$TRIM" build/asm/disc1/970C.s.o .text "$SIZE_970C"
...
SECTIONS
{
    ...
    .main 0x80010000 : AT(0x800)
    {
        ...
        build/asm/disc1/970C.s.o(.rodata)
