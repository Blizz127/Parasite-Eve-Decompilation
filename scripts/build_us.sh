...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/93EC.s.o asm/disc1/93EC.s
...
python3 "$TRIM" build/asm/disc1/93EC.s.o .text "$SIZE_93EC"
...
SECTIONS
{
    ...
    .main 0x80010000 : AT(0x800)
    {
        ...
        build/asm/disc1/93EC.s.o(.rodata)
