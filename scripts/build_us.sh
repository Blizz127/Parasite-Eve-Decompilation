...
# Phase 5BB file-span sizes (config subsegment edges; exclusive end).
...
/* Phase 5BB ROM-order link script (fifty-one C leaves).
...
echo
echo "=== Summary ==="
echo "Assemble: OK (44 asm units)"
echo "Compile:  OK (fifty-one C leaves with Phase 4J flags; func_80051E48 -fno-delayed-branch)"
...
if [[ "$cmp_ec" -eq 0 ]]; then
    ...
    echo "Matching claim: YES (fifty-one C leaves + remaining asm)"
