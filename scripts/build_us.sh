...
# 9ADC:     0x9ADC  → 0x9C84  = 0x1A8
# C 19484:  0x9C84  → 0x9CB0  = 0x2C
# 9CB0:     0x9CB0  → 0x9FD0  = 0x320
# C 197D0:  0x9FD0  → 0x9FF0  = 0x20
# C 197F0:  0x9FF0  → 0xA010  = 0x20
# A010:     0xA010  → 0xA3E4  = 0x3D4
# C 38D0C:  0x2950C → 0x2951C = 0x10
# C 38D1C:  0x2951C → 0x29548 = 0x2C
# C 38D48:  0x29548 → 0x29574 = 0x2C
# 29574:    0x29574 → 0x2A170 = 0xBFC
# C 39970:  0x2A170 → 0x2A19C = 0x2C
# 2A19C:    0x2A19C → 0x2CDD8 = 0x2C3C
...
# 2E8FC:    0x2E8FC → 0x2EE10 = 0x514
# C 3E610:  0x2EE10 → 0x2EE80 = 0x70
# C 3E680:  0x2EE80 → 0x2EF54 = 0xD4
# 2EF54:    0x2EF54 → 0x307AC = 0x1858
...
# 41520:    0x41520 → 0x41860 = 0x340
# C 51060:  0x41860 → 0x41884 = 0x24
# C 51834:  0x42034 → 0x4204C = 0x18
# C 5184C:  0x4204C → 0x4206C = 0x20
# C 5186C:  0x4206C → 0x420A8 = 0x3C
# 420A8:    0x420A8 → 0x42648 = 0x5A0
# C 51E48:  0x42648 → 0x42658 = 0x10
# 42658:    0x42658 → 0x42D14 = 0x6BC
# C 52514:  0x42D14 → 0x42D24 = 0x10
# C 52524:  0x42D24 → 0x42D34 = 0x10
# C 52534:  0x42D34 → 0x42D58 = 0x24
# C 52558:  0x42D58 → 0x42D7C = 0x24
# C 5257C:  0x42D7C → 0x42D94 = 0x18
# 42D94:    0x42D94 → 0x42F90 = 0x1FC
# C 52790:  0x42F90 → 0x42FB4 = 0x24
# C 527B4:  0x42FB4 → 0x42FC0 = 0xC
# C 527C0:  0x42FC0 → 0x42FC8 = 0x8
# 42FC8:    0x42FC8 → 0x4308C = 0xC4
# C 5288C:  0x4308C → 0x43094 = 0x8
# 43094:    0x43094 → 0x433CC = 0x338
# C 52BCC:  0x433CC → 0x43408 = 0x3C
# 43408:    0x43408 → 0x4C4A8 = 0x90A0
...
# 55430:    0x55430 → 0x55BB8 = 0x788
# C 653B8:  0x55BB8 → 0x55C00 = 0x48
# 55C00:    0x55C00 → 0x5ADBC = 0x51BC
# C 6A5BC:  0x5ADBC → 0x5AE4C = 0x90
# C 6A64C:  0x5AE4C → 0x5AE74 = 0x28
# C 6A674:  0x5AE74 → 0x5B0D4 = 0x260
# C 6A8D4:  0x5B0D4 → 0x5B1E4 = 0x110
# 5B1E4:    0x5B1E4 → 0x5E348 = 0x3164
# C 6DB48:  0x5E348 → 0x5E39C = 0x54
# 5E39C:    0x5E39C → 0x5EFE8 = 0xC4C
...
# 6ACD0:    0x6ACD0 → 0x6B08C = 0x3BC
# C 7A88C:  0x6B08C → 0x6B0AC = 0x20
# 6B0AC:    0x6B0AC → 0x6C930 = 0x1884
# C 7C130:  0x6C930 → 0x6C93C = 0xC
# 6C93C:    0x6C93C → 0x6CD44 = 0x408
# C 7C544:  0x6CD44 → 0x6CD60 = 0x1C
# 6CD60:    0x6CD60 → 0x6E514 = 0x17B4
# C 7DD14:  0x6E514 → 0x6E538 = 0x24
# 6E538:    0x6E538 → 0x6E6A4 = 0x16C
# C 7DEA4:  0x6E6A4 → 0x6E6B0 = 0xC
# C 7DEB0:  0x6E6B0 → 0x6E6C0 = 0x10
# 6E6C0:    0x6E6C0 → 0x6FF78 = 0x18B8
# C 7F778:  0x6FF78 → 0x6FF88 = 0x10
# C 7F788:  0x6FF88 → 0x6FFA8 = 0x20
# C 7F7A8:  0x6FFA8 → 0x6FFC8 = 0x20
# 6FFC8:    0x6FFC8 → 0x703C0 = 0x3F8
...
# C 7FC64:  0x70464 → 0x70488 = 0x24
# C 7FC88:  0x70488 → 0x704AC = 0x24
...
# C 80B04:  0x71304 → 0x71324 = 0x20
# 71324:    0x71324 → 0x714C8 = 0x1A4
# C 80CC8:  0x714C8 → 0x714DC = 0x14
# 714DC:    0x714DC → 0x71A54 = 0x578
# C 81254:  0x71A54 → 0x71A68 = 0x14
# 71A68:    0x71A68 → 0x71AF4 = 0x8C
# C 812F4:  0x71AF4 → 0x71B10 = 0x1C
# 71B10:    0x71B10 → 0x71BE8 = 0xD8
# C 813E8:  0x71BE8 → 0x71C08 = 0x20
# 71C08:    0x71C08 → 0x71EF4 = 0x2EC
# C 816F4:  0x71EF4 → 0x71F14 = 0x20
# 71F14:    0x71F14 → 0x72AAC = 0xB98
# C 822AC:  0x72AAC → 0x72ABC = 0x10
# 72ABC:    0x72ABC → 0x72CF0 = 0x234
# C 824F0:  0x72CF0 → 0x72D14 = 0x24
# 72D14:    0x72D14 → 0x72D34 = 0x20
# C 82534:  0x72D34 → 0x72D54 = 0x20
# 72D54:    0x72D54 → 0x734DC = 0x788
...
# B3368:    0xB3368 → 0xB76C0 = 0x4358
# C C6EC0:  0xB76C0 → 0xB76D8 = 0x18
# C C6ED8:  0xB76D8 → 0xB76E8 = 0x10
# B76E8:    0xB76E8 → 0xB8500 = 0xE18
# C C7D00:  0xB8500 → 0xB852C = 0x2C
# B852C:    0xB852C → 0xB85C4 = 0x98
...
# B93C0:    0xB93C0 → 0xB944C = 0x8C
# C C8C4C:  0xB944C → 0xB9480 = 0x34
# B9480:    0xB9480 → 0xB9644 = 0x1C4
# C C8E44:  0xB9644 → 0xB9670 = 0x2C
# B9670:    0xB9670 → 0xB9708 = 0x98
...
# BA234:    0xBA234 → 0xBA33C = 0x108
# C C9B3C:  0xBA33C → 0xBA368 = 0x2C
# BA368:    0xBA368 → 0xBA400 = 0x98
# B9A68:    0xB9A68 → 0xBA6A0 = 0xC38
# C C9EA0:  0xBA6A0 → 0xBA6A8 = 0x8
# BA6A8:    0xBA6A8 → 0xBB4D4 = 0xE2C
# BAD74:    0xBAD74 → 0xBAED4 = 0x160
# C CA6D4:  0xBAED4 → 0xBAF00 = 0x2C
# BAF00:    0xBAF00 → 0xBAF98 = 0x98
# C CACD4:  0xBB4D4 → 0xBB4DC = 0x8
# BB4DC:    0xBB4DC → 0xBDADC = 0x2600
# BC3F0:    0xBC3F0 → 0xBC6E0 = 0x2F0
# C CBEE0:  0xBC6E0 → 0xBC70C = 0x2C
# BC70C:    0xBC70C → 0xBC7A4 = 0x98
# BC7C4:    0xBC7C4 → 0xBD6BC = 0xEF8
# C CCEBC:  0xBD6BC → 0xBD6E8 = 0x2C
# BD6E8:    0xBD6E8 → 0xBD780 = 0x98
# BDF28:    0xBDF28 → 0xBE09C = 0x174
# C CD89C:  0xBE09C → 0xBE0C8 = 0x2C
# BE0C8:    0xBE0C8 → 0xBE160 = 0x98
# BE74C:    0xBE74C → 0xBE918 = 0x1CC
# C CE118:  0xBE918 → 0xBE944 = 0x2C
# BE944:    0xBE944 → 0xBE9DC = 0x98
...
SIZE_C_438C0=0x20
SIZE_C_438E0=0xc
# Phase 5ES mid-340EC carve: 0x861c prefix + 0x38 C + 0x10e4 resume = 0x9738.
SIZE_340EC=0x38d0
SIZE_C_471BC=0x28
SIZE_379E4=0x148
SIZE_C_4732C=0x28
...
SIZE_C_527B4=0xc
SIZE_C_527C0=0x8
# Phase 5GW mid-42FC8 carve: 0xC4 prefix + 0x8 C + 0x338 asm + 0x3C C + 0x2A8 resume.
SIZE_42FC8=0xc4
SIZE_C_5288C=0x8
SIZE_43094=0x338
SIZE_C_52BCC=0x3c
...
OBJECTS=(
    ...
    "build/src/func_800182A0.c.o"
    "build/src/func_800182C0.c.o"
    "build/src/func_800182E0.c.o"
    "build/asm/disc1/8B00.s.o"
    "build/src/func_80018B00.c.o"
    "build/asm/disc1/9330.s.o"
    "build/src/func_80018B68.c.o"
    "build/asm/disc1/9398.s.o"
    "build/src/func_80018BC8.c.o"
    "build/src/func_80018BEC.c.o"
    "build/asm/disc1/9410.s.o"
    "build/src/func_80018C58.c.o"
    ...
    "build/src/func_80018E58.c.o"
    "build/asm/disc1/9684.s.o"
    "build/src/func_80018EB4.c.o"
    "build/src/func_80018EE0.c.o"
    "build/src/func_80018F0C.c.o"
    "build/src/func_80018F54.c.o"
    "build/asm/disc1/9774.s.o"
    ...
    "build/src/func_80019484.c.o"
    "build/asm/disc1/9CB0.s.o"
    "build/src/func_800197D0.c.o"
    "build/src/func_800197F0.c.o"
    "build/asm/disc1/A010.s.o"
    ...
    "build/src/func_80030640.c.o"
    "build/asm/disc1/20EE0.s.o"
    "build/src/func_80033A20.c.o"
    "build/src/func_80033A2C.c.o"
    "build/asm/disc1/24240.s.o"
    "build/src/func_800363F4.c.o"
    "build/asm/disc1/26C48.s.o"
    "build/src/func_80036E34.c.o"
    "build/src/func_80036E58.c.o"
    "build/asm/disc1/2767C.s.o"
    "build/src/func_800370A8.c.o"
    "build/asm/disc1/278BC.s.o"
    "build/src/func_800370DC.c.o"
    "build/src/func_80037140.c.o"
    "build/src/func_800371A4.c.o"
    "build/asm/disc1/279B0.s.o"
    "build/src/func_80037454.c.o"
    "build/asm/disc1/27C6C.s.o"
    "build/src/func_80037548.c.o"
    ...
    "build/src/func_80039970.c.o"
    "build/asm/disc1/2A19C.s.o"
    ...
    "build/src/func_8003E0D0.c.o"
    "build/asm/disc1/2E8FC.s.o"
    "build/src/func_8003E610.c.o"
    "build/src/func_8003E680.c.o"
    "build/asm/disc1/2EF54.s.o"
    ...
    "build/src/func_800471BC.c.o"
    "build/asm/disc1/379E4.s.o"
    "build/src/func_8004732C.c.o"
    "build/asm/disc1/37B54.s.o"
    "build/src/func_800474A8.c.o"
    "build/asm/disc1/37CD0.s.o"
    "build/src/func_8004B534.c.o"
    "build/src/func_8004B55C.c.o"
    "build/asm/disc1/3BD84.s.o"
    "build/src/func_8004BF08.c.o"
    "build/asm/disc1/3C740.s.o"
    ...
    "build/src/func_8004D4A0.c.o"
    "build/asm/disc1/3DCC4.s.o"
    ...
    "build/src/func_8004EF30.c.o"
    "build/asm/disc1/3F758.s.o"
    "build/src/func_8004F2E4.c.o"
    "build/asm/disc1/3FB0C.s.o"
    "build/src/func_8004F448.c.o"
    "build/asm/disc1/3FC64.s.o"
    "build/src/func_8004F808.c.o"
    "build/asm/disc1/40038.s.o"
    "build/src/func_8004F950.c.o"
    "build/src/func_8004F978.c.o"
    "build/asm/disc1/401A0.s.o"
    "build/src/func_8004FF30.c.o"
    "build/src/func_8004FF58.c.o"
    "build/src/func_8004FF80.c.o"
    "build/src/func_8004FFA8.c.o"
    "build/src/func_8004FFD0.c.o"
    "build/src/func_8004FFF8.c.o"
    "build/src/func_80050020.c.o"
    "build/src/func_80050038.c.o"
    "build/src/func_80050060.c.o"
    "build/src/func_80050088.c.o"
    "build/asm/disc1/408A8.s.o"
    "build/src/func_80050204.c.o"
    "build/asm/disc1/40A2C.s.o"
    "build/src/func_80050260.c.o"
    "build/asm/disc1/40A80.s.o"
    "build/src/func_800506E8.c.o"
    "build/src/func_80050708.c.o"
    "build/src/func_80050728.c.o"
    "build/asm/disc1/40F48.s.o"
    "build/src/func_80050BE8.c.o"
    "build/asm/disc1/41408.s.o"
    "build/src/func_80050C50.c.o"
    "build/asm/disc1/41470.s.o"
    "build/src/func_80050CF8.c.o"
    "build/src/func_80050D18.c.o"
    "build/asm/disc1/41520.s.o"
    "build/src/func_80051060.c.o"
    ...
    "build/src/func_8005184C.c.o"
    "build/src/func_8005186C.c.o"
    "build/asm/disc1/420A8.s.o"
    ...
    "build/src/func_80052534.c.o"
    "build/src/func_80052558.c.o"
    "build/src/func_8005257C.c.o"
    "build/asm/disc1/42D94.s.o"
    "build/src/func_80052790.c.o"
    "build/src/func_800527B4.c.o"
    "build/src/func_800527C0.c.o"
    "build/asm/disc1/42FC8.s.o"
    "build/src/func_8005288C.c.o"
    "build/asm/disc1/43094.s.o"
    "build/src/func_80052BCC.c.o"
    "build/asm/disc1/43408.s.o"
    ...
    "build/src/func_80055FB4.c.o"
    "build/asm/disc1/467E0.s.o"
    ...
    "build/src/func_8005BEE8.c.o"
    "build/asm/disc1/4C708.s.o"
    "build/src/func_8005C488.c.o"
    "build/asm/disc1/4CC98.s.o"
    "build/src/func_8005D970.c.o"
    "build/asm/disc1/4E194.s.o"
    "build/src/func_8005DADC.c.o"
    "build/asm/disc1/4E2FC.s.o"
    ...
    "build/src/func_8005E8A4.c.o"
    "build/asm/disc1/4F0C4.s.o"
    "build/src/func_8005E968.c.o"
    "build/asm/disc1/4F188.s.o"
    "build/src/func_8005EB58.c.o"
    "build/asm/disc1/4F364.s.o"
    "build/src/func_8005EEC8.c.o"
    "build/asm/disc1/4F6D4.s.o"
    "build/src/func_8005F594.c.o"
    "build/asm/disc1/4FDB8.s.o"
    ...
    "build/src/func_80062F1C.c.o"
    "build/asm/disc1/5373C.s.o"
    ...
    "build/src/func_80064C30.c.o"
    "build/asm/disc1/55454.s.o"
    "build/src/func_80064E90.c.o"
    "build/asm/disc1/556B4.s.o"
    "build/src/func_800653B8.c.o"
    "build/asm/disc1/55C00.s.o"
    "build/src/func_8006A5BC.c.o"
    "build/src/func_8006A64C.c.o"
    "build/src/func_8006A674.c.o"
    "build/src/func_8006A8D4.c.o"
    "build/asm/disc1/5B1E4.s.o"
    "build/src/func_8006DB48.c.o"
    "build/asm/disc1/5E39C.s.o"
    ...
    "build/src/func_80077A64.c.o"
    "build/asm/disc1/682A0.s.o"
    "build/src/func_80077AA4.c.o"
    "build/asm/disc1/682BC.s.o"
    "build/src/func_80077B04.c.o"
    "build/asm/disc1/6832C.s.o"
    "build/src/func_80077B34.c.o"
    "build/asm/disc1/6835C.s.o"
    ...
    "build/src/func_80077CB4.c.o"
    "build/asm/disc1/684EC.s.o"
    ...
    "build/src/func_8007A88C.c.o"
    "build/asm/disc1/6B0AC.s.o"
    "build/src/func_8007A8EC.c.o"
    "build/asm/disc1/6B110.s.o"
    "build/src/func_8007C130.c.o"
    "build/asm/disc1/6C93C.s.o"
    "build/src/func_8007C544.c.o"
    "build/asm/disc1/6CD60.s.o"
    "build/src/func_8007DD14.c.o"
    "build/asm/disc1/6E538.s.o"
    "build/src/func_8007DEA4.c.o"
    "build/src/func_8007DEB0.c.o"
    "build/asm/disc1/6E6C0.s.o"
    "build/src/func_8007F778.c.o"
    "build/src/func_8007F788.c.o"
    "build/src/func_8007F7A8.c.o"
    "build/asm/disc1/6FFC8.s.o"
    ...
    "build/src/func_8007FC64.c.o"
    "build/src/func_8007FC88.c.o"
    ...
    "build/src/func_80080B04.c.o"
    "build/asm/disc1/71324.s.o"
    ...
    "build/src/func_800813E8.c.o"
    "build/asm/disc1/71C08.s.o"
    "build/src/func_800816F4.c.o"
    "build/asm/disc1/71F14.s.o"
    "build/src/func_800822AC.c.o"
    "build/asm/disc1/72ABC.s.o"
    "build/src/func_800824F0.c.o"
    "build/asm/disc1/72D14.s.o"
    "build/src/func_80082534.c.o"
    "build/asm/disc1/72D54.s.o"
    ...
    "build/src/func_80083C20.c.o"
    "build/asm/disc1/7443C.s.o"
    "build/src/func_80083E50.c.o"
    "build/src/func_80083E70.c.o"
    "build/src/func_80083E84.c.o"
    "build/src/func_80083EA4.c.o"
    "build/src/func_80083EC4.c.o"
    "build/src/func_80083EE4.c.o"
    "build/asm/disc1/746F8.s.o"
    "build/src/func_800847A0.c.o"
    "build/asm/disc1/74FB0.s.o"
    "build/src/func_80084FC4.c.o"
    "build/asm/disc1/757E4.s.o"
    "build/src/func_80085084.c.o"
    "build/asm/disc1/75898.s.o"
    "build/src/func_80085728.c.o"
    "build/asm/disc1/75F44.s.o"
    "build/src/func_80085DC4.c.o"
    "build/asm/disc1/765E8.s.o"
    ...
    "build/src/func_8008777C.c.o"
    "build/asm/disc1/77F98.s.o"
    "build/src/func_800877BC.c.o"
    "build/src/func_800877D4.c.o"
    "build/src/func_800877F0.c.o"
    "build/asm/disc1/7800C.s.o"
    "build/src/func_8008788C.c.o"
    "build/src/func_800878C0.c.o"
    "build/asm/disc1/780F0.s.o"
    ...
    "build/src/func_800C2AF0.c.o"
    "build/asm/disc1/B3310.s.o"
    "build/src/func_800C2B40.c.o"
    "build/src/func_800C2B50.c.o"
    "build/asm/disc1/B3368.s.o"
    "build/src/func_800C6EC0.c.o"
    "build/src/func_800C6ED8.c.o"
    "build/asm/disc1/B76E8.s.o"
    "build/src/func_800C7D00.c.o"
    "build/asm/disc1/B852C.s.o"
    ...
    "build/src/func_800C8C4C.c.o"
    "build/asm/disc1/B9480.s.o"
    "build/src/func_800C8E44.c.o"
    "build/asm/disc1/B9670.s.o"
    ...
    "build/src/func_800C9A00.c.o"
    "build/asm/disc1/BA234.s.o"
    "build/src/func_800C9B3C.c.o"
    "build/asm/disc1/BA368.s.o"
    "build/src/func_800C9C00.c.o"
    "build/src/func_800C9C10.c.o"
    "build/src/func_800C9C18.c.o"
    "build/asm/disc1/BA420.s.o"
    ...
    "build/src/func_800CA6D4.c.o"
    "build/asm/disc1/BAF00.s.o"
    "build/src/func_800CA798.c.o"
    "build/src/func_800CA7A8.c.o"
    "build/src/func_800CA7B0.c.o"
    "build/asm/disc1/BAFB8.s.o"
    "build/src/func_800CACD4.c.o"
    "build/asm/disc1/BB4DC.s.o"
    "build/src/func_800CBB24.c.o"
    "build/asm/disc1/BC330.s.o"
    "build/src/func_800CBBBC.c.o"
    "build/asm/disc1/BC3F0.s.o"
    "build/src/func_800CBEE0.c.o"
    "build/asm/disc1/BC70C.s.o"
    "build/src/func_800CBFA4.c.o"
    "build/src/func_800CBFB4.c.o"
    "build/src/func_800CBFBC.c.o"
    "build/asm/disc1/BC7C4.s.o"
    "build/src/func_800CCEBC.c.o"
    "build/asm/disc1/BD6E8.s.o"
    "build/src/func_800CCF80.c.o"
    "build/src/func_800CCF90.c.o"
    "build/src/func_800CCF98.c.o"
    "build/asm/disc1/BD7A0.s.o"
    ...
    "build/src/func_800CD89C.c.o"
    "build/asm/disc1/BE0C8.s.o"
    "build/src/func_800CD960.c.o"
    "build/src/func_800CD970.c.o"
    "build/src/func_800CD978.c.o"
    "build/asm/disc1/BE180.s.o"
    "build/src/func_800CDD04.c.o"
    "build/asm/disc1/BE50C.s.o"
    "build/src/func_800CDF40.c.o"
    "build/asm/disc1/BE74C.s.o"
    "build/src/func_800CE118.c.o"
    "build/asm/disc1/BE944.s.o"
    "build/src/func_800CE1DC.c.o"
    "build/src/func_800CE1EC.c.o"
    "build/src/func_800CE1F4.c.o"
    "build/asm/disc1/BE9FC.s.o"
    "build/src/func_800CE3AC.c.o"
    "build/asm/disc1/BEBB4.s.o"
    "build/src/func_800CE464.c.o"
    "build/src/func_800CE470.c.o"
    "build/asm/disc1/BEC9C.s.o"
    "build/src/func_800CE870.c.o"
    "build/asm/disc1/BF0F0.s.o"
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/9684.s.o asm/disc1/9684.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/9774.s.o asm/disc1/9774.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/9CB0.s.o asm/disc1/9CB0.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/2767C.s.o asm/disc1/2767C.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/2A19C.s.o asm/disc1/2A19C.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/2EF54.s.o asm/disc1/2EF54.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/379E4.s.o asm/disc1/379E4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/37B54.s.o asm/disc1/37B54.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/37CD0.s.o asm/disc1/37CD0.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/3BD84.s.o asm/disc1/3BD84.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/3C740.s.o asm/disc1/3C740.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/3DCC4.s.o asm/disc1/3DCC4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/3E2A4.s.o asm/disc1/3E2A4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/3E4A4.s.o asm/disc1/3E4A4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/3F17C.s.o asm/disc1/3F17C.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/3F758.s.o asm/disc1/3F758.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/3FB0C.s.o asm/disc1/3FB0C.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/401A0.s.o asm/disc1/401A0.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/408A8.s.o asm/disc1/408A8.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/40A2C.s.o asm/disc1/40A2C.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/40A80.s.o asm/disc1/40A80.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/40F48.s.o asm/disc1/40F48.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/41408.s.o asm/disc1/41408.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/41470.s.o asm/disc1/41470.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/420A8.s.o asm/disc1/420A8.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/43094.s.o asm/disc1/43094.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/43408.s.o asm/disc1/43408.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/467E0.s.o asm/disc1/467E0.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/4C708.s.o asm/disc1/4C708.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/4CC98.s.o asm/disc1/4CC98.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/4E194.s.o asm/disc1/4E194.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/4E2FC.s.o asm/disc1/4E2FC.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/4F0C4.s.o asm/disc1/4F0C4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/4F188.s.o asm/disc1/4F188.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/4FDB8.s.o asm/disc1/4FDB8.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/5373C.s.o asm/disc1/5373C.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/55454.s.o asm/disc1/55454.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/556B4.s.o asm/disc1/556B4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/55C00.s.o asm/disc1/55C00.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/5B1E4.s.o asm/disc1/5B1E4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/5E39C.s.o asm/disc1/5E39C.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/682A0.s.o asm/disc1/682A0.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/682BC.s.o asm/disc1/682BC.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/6832C.s.o asm/disc1/6832C.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/6835C.s.o asm/disc1/6835C.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/684EC.s.o asm/disc1/684EC.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/6B0AC.s.o asm/disc1/6B0AC.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/6B110.s.o asm/disc1/6B110.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/6E538.s.o asm/disc1/6E538.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/71324.s.o asm/disc1/71324.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/71C08.s.o asm/disc1/71C08.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/71F14.s.o asm/disc1/71F14.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/72ABC.s.o asm/disc1/72ABC.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/72D14.s.o asm/disc1/72D14.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/72D54.s.o asm/disc1/72D54.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/7443C.s.o asm/disc1/7443C.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/757E4.s.o asm/disc1/757E4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/75898.s.o asm/disc1/75898.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/75F44.s.o asm/disc1/75F44.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/765E8.s.o asm/disc1/765E8.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/77F98.s.o asm/disc1/77F98.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/7800C.s.o asm/disc1/7800C.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/780F0.s.o asm/disc1/780F0.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/B3310.s.o asm/disc1/B3310.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/B3368.s.o asm/disc1/B3368.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/B76E8.s.o asm/disc1/B76E8.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/B852C.s.o asm/disc1/B852C.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/B9480.s.o asm/disc1/B9480.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/B9670.s.o asm/disc1/B9670.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BA234.s.o asm/disc1/BA234.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BA368.s.o asm/disc1/BA368.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BAF00.s.o asm/disc1/BAF00.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BC3F0.s.o asm/disc1/BC3F0.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BC70C.s.o asm/disc1/BC70C.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BC7C4.s.o asm/disc1/BC7C4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BD6E8.s.o asm/disc1/BD6E8.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BD7A0.s.o asm/disc1/BD7A0.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BE0C8.s.o asm/disc1/BE0C8.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BE180.s.o asm/disc1/BE180.s
...
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BE944.s.o asm/disc1/BE944.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BE9FC.s.o asm/disc1/BE9FC.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BEBB4.s.o asm/disc1/BEBB4.s
run "$AS" $ASFLAGS_DEFAULT -I "$ROOT/include" -o build/asm/disc1/BEC9C.s.o asm/disc1/BEC9C.s
...
era_compile src/func_800182A0.c build/src/func_800182A0.c.o -O2 -G0
era_compile src/func_800182C0.c build/src/func_800182C0.c.o -O2 -G0
era_compile src/func_800182E0.c build/src/func_800182E0.c.o -O2 -G0
era_compile src/func_80018B00.c build/src/func_80018B00.c.o -O2 -G0
era_compile src/func_80018B68.c build/src/func_80018B68.c.o -O2 -G0
era_compile src/func_80018BC8.c build/src/func_80018BC8.c.o -O2 -G0
era_compile src/func_80018BEC.c build/src/func_80018BEC.c.o -O2 -G0
era_compile src/func_80018C58.c build/src/func_80018C58.c.o -O2 -G0
...
era_compile src/func_80018E58.c build/src/func_80018E58.c.o -O2 -G0
era_compile src/func_80018EB4.c build/src/func_80018EB4.c.o -O2 -G0
era_compile src/func_80018EE0.c build/src/func_80018EE0.c.o -O2 -G0
era_compile src/func_80018F0C.c build/src/func_80018F0C.c.o -O2 -G0
era_compile src/func_80018F54.c build/src/func_80018F54.c.o -O2 -G0
era_compile src/func_80039970.c build/src/func_80039970.c.o -O2 -G0
...
era_compile src/func_80062F1C.c build/src/func_80062F1C.c.o -O2 -G0
...
era_compile src/func_80064C30.c build/src/func_80064C30.c.o -O2 -G8
era_compile src/func_80064E90.c build/src/func_80064E90.c.o -O2 -G0
era_compile src/func_8005F594.c build/src/func_8005F594.c.o -O2 -G8
...
era_compile src/func_80077CB4.c build/src/func_80077CB4.c.o -O2 -G0
...
# Phase 5FD: 7-slot table clear. Retail keeps symbol+register at the store
# (lui $at / addu $at,$at,$v1 / sw $zero,%lo($at)); the aggregate element type
# is what makes cc1 emit `sw $0,SYM($3)` instead of hoisting `la` out of the
...
# 2.30 enables maspsx nop_mflo_mfhi (off under 2.21): the second square
# needs the mflo/subu/nop/mult gap that 2.21 omits. Other 2.30 knobs
# (nop_at_expansion/addiu_at) are unused in this leaf.
ERA_ASPSX_VER=2.30 era_compile src/func_80030534.c build/src/func_80030534.c.o -O2 -G0
...
era_compile src/func_800370DC.c build/src/func_800370DC.c.o -O2 -G0
era_compile src/func_80033A2C.c build/src/func_80033A2C.c.o -O2 -G0
era_compile src/func_80037140.c build/src/func_80037140.c.o -O2 -G0
...
era_compile src/func_8003E0D0.c build/src/func_8003E0D0.c.o -O2 -G0
# Phase 5EY: boot display/graphics bring-up; straight-line dispatcher,
# ten calls with immediate args (320x224 display res). -O2 -G0 exact.
era_compile src/func_8003E610.c build/src/func_8003E610.c.o -O2 -G0
# Phase 5FA: boot subsystem-init dispatcher; -O1 for per-store lui (no CSE)
# + unsigned loop counter (ROM sltiu); first fn-ptr-to-asm-callee arg.
era_compile src/func_8003E680.c build/src/func_8003E680.c.o -O1 -G0
...
era_compile src/func_800471BC.c build/src/func_800471BC.c.o -O2 -G0
era_compile src/func_8004732C.c build/src/func_8004732C.c.o -O2 -G0
era_compile src/func_800474A8.c build/src/func_800474A8.c.o -O2 -G0
era_compile src/func_8004B534.c build/src/func_8004B534.c.o -O2 -G0
era_compile src/func_8004B55C.c build/src/func_8004B55C.c.o -O2 -G0
era_compile src/func_8004EF30.c build/src/func_8004EF30.c.o -O2 -G0
era_compile src/func_8004F2E4.c build/src/func_8004F2E4.c.o -O2 -G0
era_compile src/func_8004F950.c build/src/func_8004F950.c.o -O2 -G0
era_compile src/func_8004F978.c build/src/func_8004F978.c.o -O2 -G0
era_compile src/func_8004FF30.c build/src/func_8004FF30.c.o -O2 -G0
era_compile src/func_8004FF58.c build/src/func_8004FF58.c.o -O2 -G0
era_compile src/func_8004FF80.c build/src/func_8004FF80.c.o -O2 -G0
era_compile src/func_8004FFA8.c build/src/func_8004FFA8.c.o -O2 -G0
era_compile src/func_8004FFD0.c build/src/func_8004FFD0.c.o -O2 -G0
era_compile src/func_8004FFF8.c build/src/func_8004FFF8.c.o -O2 -G0
era_compile src/func_80050038.c build/src/func_80050038.c.o -O2 -G0
era_compile src/func_80050060.c build/src/func_80050060.c.o -O2 -G0
era_compile src/func_80050204.c build/src/func_80050204.c.o -O2 -G0
era_compile src/func_80051060.c build/src/func_80051060.c.o -O2 -G8
...
era_compile src/func_8007A88C.c build/src/func_8007A88C.c.o -O2 -G0
era_compile src/func_8007A8EC.c build/src/func_8007A8EC.c.o -O2 -G0
...
era_compile src/func_8007FC64.c build/src/func_8007FC64.c.o -O2 -G0
era_compile src/func_8007FC88.c build/src/func_8007FC88.c.o -O2 -G0
MASPSX_FILL_STORE_DELAY_SLOT=1 era_compile src/func_80080930.c build/src/func_80080930.c.o -O2 -G0
era_compile src/func_80080AE4.c build/src/func_80080AE4.c.o -O2 -G0
...
MASPSX_FILL_STORE_DELAY_SLOT=1 era_compile src/func_80084FC4.c build/src/func_80084FC4.c.o -O2 -G0
...
era_compile src/func_80085DC4.c build/src/func_80085DC4.c.o -O2 -G0
era_compile src/func_800C2AF0.c build/src/func_800C2AF0.c.o -O2 -G0
era_compile src/func_800C6EC0.c build/src/func_800C6EC0.c.o -O2 -G0
era_compile src/func_800C6ED8.c build/src/func_800C6ED8.c.o -O2 -G0
era_compile src/func_800C7D00.c build/src/func_800C7D00.c.o -O2 -G0
...
era_compile src/func_800C8C4C.c build/src/func_800C8C4C.c.o -O2 -G0
era_compile src/func_800C8E44.c build/src/func_800C8E44.c.o -O2 -G0
...
era_compile src/func_800C9A00.c build/src/func_800C9A00.c.o -O2 -G0
era_compile src/func_800C9B3C.c build/src/func_800C9B3C.c.o -O2 -G0
...
era_compile src/func_800CA6D4.c build/src/func_800CA6D4.c.o -O2 -G0
...
era_compile src/func_800CBBBC.c build/src/func_800CBBBC.c.o -O2 -G0
era_compile src/func_800CBEE0.c build/src/func_800CBEE0.c.o -O2 -G0
era_compile src/func_800CBFB4.c build/src/func_800CBFB4.c.o -O2 -G0
era_compile src/func_800CBFBC.c build/src/func_800CBFBC.c.o -O2 -G0
era_compile src/func_800CCEBC.c build/src/func_800CCEBC.c.o -O2 -G0
era_compile src/func_800CCF80.c build/src/func_800CCF80.c.o -O2 -G0
era_compile src/func_800CCF90.c build/src/func_800CCF90.c.o -O2 -G0
era_compile src/func_800CCF98.c build/src/func_800CCF98.c.o -O2 -G0
era_compile src/func_800CD89C.c build/src/func_800CD89C.c.o -O2 -G0
era_compile src/func_800CD960.c build/src/func_800CD960.c.o -O2 -G0
era_compile src/func_800CD970.c build/src/func_800CD970.c.o -O2 -G0
era_compile src/func_800CD978.c build/src/func_800CD978.c.o -O2 -G0
era_compile src/func_800CE118.c build/src/func_800CE118.c.o -O2 -G0
era_compile src/func_800CE1DC.c build/src/func_800CE1DC.c.o -O2 -G0
era_compile src/func_800CE1EC.c build/src/func_800CE1EC.c.o -O2 -G0
era_compile src/func_800CE1F4.c build/src/func_800CE1F4.c.o -O2 -G0
era_compile src/func_800CE470.c build/src/func_800CE470.c.o -O2 -G0
...
# Phase 5EJ: double-dereference int **arg0 into outgoing $a0, jal func_800438C0, return 1.
era_compile src/func_80019484.c build/src/func_80019484.c.o -O2 -G0
# Phase 5EI: first non-leaf — frame + jal func_800375B4, return 1; era -O2 (mirrors 5EH).
era_compile src/func_800197D0.c build/src/func_800197D0.c.o -O2 -G8
# Phase 5EK: volume-cadence twin — frame + jal func_800375C4, return 1; no $gp.
era_compile src/func_800197F0.c build/src/func_800197F0.c.o -O2 -G0
...
era_compile src/func_8007DD14.c build/src/func_8007DD14.c.o -O2 -G0
era_compile src/func_80080AC4.c build/src/func_80080AC4.c.o -O2 -G0
era_compile src/func_80080B04.c build/src/func_80080B04.c.o -O2 -G0
era_compile src/func_800813E8.c build/src/func_800813E8.c.o -O2 -G0
era_compile src/func_800816F4.c build/src/func_800816F4.c.o -O2 -G0
era_compile src/func_800824F0.c build/src/func_800824F0.c.o -O2 -G0
era_compile src/func_80082534.c build/src/func_80082534.c.o -O2 -G0
...
era_compile src/func_8006E834.c build/src/func_8006E834.c.o -O2 -G0
# Phase 5FJ: boot display init + pointer arena + poll loop + dispatch exit;
# 6A8D4 pins + $s0/$s2 pins + asm barrier (source-documented).
era_compile src/func_8006E9A0.c build/src/func_8006E9A0.c.o -O2 -G0
# Phase 5EQ: boot wrapper; two void(void) calls, teardown before jr.
# Phase 5EZ: boot init, two VSync-polled wait loops; -O1 for per-use $s0=1
# materialization (in 86FF8's delay slot and again between the loops).
era_compile src/func_8006A5BC.c build/src/func_8006A5BC.c.o -O1 -G0
era_compile src/func_8006A64C.c build/src/func_8006A64C.c.o -O2 -G0
# Phase 5EX: boot state initializer; -O1 for per-use const materialization,
...
era_compile src/func_80077A64.c build/src/func_80077A64.c.o -O2 -G0
era_compile src/func_80077AA4.c build/src/func_80077AA4.c.o -O2 -G0
era_compile src/func_80077B04.c build/src/func_80077B04.c.o -O2 -G0
era_compile src/func_80077B34.c build/src/func_80077B34.c.o -O2 -G0
era_compile src/func_800877BC.c build/src/func_800877BC.c.o -O2 -G0
...
era_compile src/func_8008777C.c build/src/func_8008777C.c.o -O2 -G0
era_compile src/func_800877D4.c build/src/func_800877D4.c.o -O2 -G0
era_compile src/func_800877F0.c build/src/func_800877F0.c.o -O2 -G0
era_compile src/func_8008788C.c build/src/func_8008788C.c.o -O2 -G0
era_compile src/func_800878C0.c build/src/func_800878C0.c.o -O2 -G0
era_compile src/func_80083C20.c build/src/func_80083C20.c.o -O2 -G0
era_compile src/func_80083E50.c build/src/func_80083E50.c.o -O2 -G0
era_compile src/func_80083E84.c build/src/func_80083E84.c.o -O2 -G0
era_compile src/func_80083EA4.c build/src/func_80083EA4.c.o -O2 -G0
era_compile src/func_80083EC4.c build/src/func_80083EC4.c.o -O2 -G0
era_compile src/func_8005E8A4.c build/src/func_8005E8A4.c.o -O2 -G8
era_compile src/func_8005E968.c build/src/func_8005E968.c.o -O2 -G8
...
era_compile src/func_80050088.c build/src/func_80050088.c.o -O2 -G0
era_compile src/func_80050260.c build/src/func_80050260.c.o -O2 -G0
era_compile src/func_800506E8.c build/src/func_800506E8.c.o -O2 -G0
era_compile src/func_80050708.c build/src/func_80050708.c.o -O2 -G0
era_compile src/func_80050728.c build/src/func_80050728.c.o -O2 -G0
era_compile src/func_80050BE8.c build/src/func_80050BE8.c.o -O2 -G0
era_compile src/func_80050C50.c build/src/func_80050C50.c.o -O2 -G0
era_compile src/func_80050CF8.c build/src/func_80050CF8.c.o -O2 -G0
era_compile src/func_80052534.c build/src/func_80052534.c.o -O2 -G0
era_compile src/func_80052558.c build/src/func_80052558.c.o -O2 -G0
era_compile src/func_80052790.c build/src/func_80052790.c.o -O2 -G8
...
# Phase 5EW: rotated copy-until-0xFF loop; first -fschedule-insns2 leaf
# (post-alloc scheduler hoists the head li into the lbu delay like ccpsx).
era_compile src/func_80052BCC.c build/src/func_80052BCC.c.o -O1 -G0 -fschedule-insns2
...
era_compile src/func_80036E34.c build/src/func_80036E34.c.o -O2 -G0
era_compile src/func_80036E58.c build/src/func_80036E58.c.o -O2 -G0
...
run "$CC" $CFLAGS_LEAF -c -o build/src/func_8009059C.c.o src/func_8009059C.c
run "$CC" $CFLAGS_LEAF -c -o build/src/func_800905C4.c.o src/func_800905C4.c
...
run "$CC" $CFLAGS_LEAF -c -o build/src/func_8009068C.c.o src/func_8009068C.c
...
python3 "$TRIM" build/src/func_80012700.c.o .text "$SIZE_C_12700"
...
python3 "$TRIM" build/src/func_80017EC4.c.o .text "$SIZE_C_17EC4"
...
python3 "$TRIM" build/src/func_800182A0.c.o .text "$SIZE_C_182A0"
python3 "$TRIM" build/src/func_800182C0.c.o .text "$SIZE_C_182C0"
python3 "$TRIM" build/src/func_800182E0.c.o .text "$SIZE_C_182E0"
python3 "$TRIM" build/asm/disc1/8B00.s.o .text "$SIZE_8B00"
python3 "$TRIM" build/src/func_80018B00.c.o .text "$SIZE_C_18B00"
python3 "$TRIM" build/asm/disc1/9330.s.o .text "$SIZE_9330"
python3 "$TRIM" build/src/func_80018B68.c.o .text "$SIZE_C_18B68"
python3 "$TRIM" build/asm/disc1/9398.s.o .text "$SIZE_9398"
python3 "$TRIM" build/src/func_80018BC8.c.o .text "$SIZE_C_18BC8"
python3 "$TRIM" build/src/func_80018BEC.c.o .text "$SIZE_C_18BEC"
python3 "$TRIM" build/asm/disc1/9410.s.o .text "$SIZE_9410"
python3 "$TRIM" build/src/func_80018C58.c.o .text "$SIZE_C_18C58"
...
python3 "$TRIM" build/src/func_80018E58.c.o .text "$SIZE_C_18E58"
python3 "$TRIM" build/asm/disc1/9684.s.o .text "$SIZE_9684"
python3 "$TRIM" build/src/func_80018EB4.c.o .text "$SIZE_C_18EB4"
python3 "$TRIM" build/src/func_80018EE0.c.o .text "$SIZE_C_18EE0"
python3 "$TRIM" build/src/func_80018F0C.c.o .text "$SIZE_C_18F0C"
python3 "$TRIM" build/src/func_80018F54.c.o .text "$SIZE_C_18F54"
python3 "$TRIM" build/asm/disc1/9774.s.o .text "$SIZE_9774"
...
python3 "$TRIM" build/src/func_80019484.c.o .text "$SIZE_C_19484"
python3 "$TRIM" build/asm/disc1/9CB0.s.o .text "$SIZE_9CB0"
python3 "$TRIM" build/src/func_800197D0.c.o .text "$SIZE_C_197D0"
python3 "$TRIM" build/src/func_800197F0.c.o .text "$SIZE_C_197F0"
python3 "$TRIM" build/asm/disc1/A010.s.o .text "$SIZE_A010"
...
python3 "$TRIM" build/src/func_80030640.c.o .text "$SIZE_C_30640"
python3 "$TRIM" build/asm/disc1/20EE0.s.o .text "$SIZE_20EE0"
python3 "$TRIM" build/src/func_80033A20.c.o .text "$SIZE_C_33A20"
python3 "$TRIM" build/src/func_80033A2C.c.o .text "$SIZE_C_33A2C"
python3 "$TRIM" build/asm/disc1/24240.s.o .text "$SIZE_24240"
python3 "$TRIM" build/src/func_800363F4.c.o .text "$SIZE_C_363F4"
python3 "$TRIM" build/asm/disc1/26C48.s.o .text "$SIZE_26C48"
python3 "$TRIM" build/src/func_80036E34.c.o .text "$SIZE_C_36E34"
python3 "$TRIM" build/src/func_80036E58.c.o .text "$SIZE_C_36E58"
python3 "$TRIM" build/asm/disc1/2767C.s.o .text "$SIZE_2767C"
python3 "$TRIM" build/src/func_800370A8.c.o .text "$SIZE_C_370A8"
python3 "$TRIM" build/asm/disc1/278BC.s.o .text "$SIZE_278BC"
python3 "$TRIM" build/src/func_800370DC.c.o .text "$SIZE_C_370DC"
python3 "$TRIM" build/src/func_80037140.c.o .text "$SIZE_C_37140"
...
python3 "$TRIM" build/src/func_80037548.c.o .text "$SIZE_C_37548"
...
python3 "$TRIM" build/src/func_80039970.c.o .text "$SIZE_C_39970"
python3 "$TRIM" build/asm/disc1/2A19C.s.o .text "$SIZE_2A19C"
...
python3 "$TRIM" build/src/func_8003E0D0.c.o .text "$SIZE_C_3E0D0"
python3 "$TRIM" build/asm/disc1/2E8FC.s.o .text "$SIZE_2E8FC"
python3 "$TRIM" build/src/func_8003E610.c.o .text "$SIZE_C_3E610"
python3 "$TRIM" build/src/func_8003E680.c.o .text "$SIZE_C_3E680"
python3 "$TRIM" build/asm/disc1/2EF54.s.o .text "$SIZE_2EF54"
...
python3 "$TRIM" build/src/func_800471BC.c.o .text "$SIZE_C_471BC"
python3 "$TRIM" build/asm/disc1/379E4.s.o .text "$SIZE_379E4"
python3 "$TRIM" build/src/func_8004732C.c.o .text "$SIZE_C_4732C"
python3 "$TRIM" build/asm/disc1/37B54.s.o .text "$SIZE_37B54"
python3 "$TRIM" build/src/func_800474A8.c.o .text "$SIZE_C_474A8"
python3 "$TRIM" build/asm/disc1/37CD0.s.o .text "$SIZE_37CD0"
python3 "$TRIM" build/src/func_8004B534.c.o .text "$SIZE_C_4B534"
python3 "$TRIM" build/src/func_8004B55C.c.o .text "$SIZE_C_4B55C"
python3 "$TRIM" build/asm/disc1/3BD84.s.o .text "$SIZE_3BD84"
python3 "$TRIM" build/src/func_8004BF08.c.o .text "$SIZE_C_4BF08"
python3 "$TRIM" build/asm/disc1/3C740.s.o .text "$SIZE_3C740"
...
python3 "$TRIM" build/src/func_8004D4A0.c.o .text "$SIZE_C_4D4A0"
python3 "$TRIM" build/asm/disc1/3DCC4.s.o .text "$SIZE_3DCC4"
...
python3 "$TRIM" build/src/func_8004EF30.c.o .text "$SIZE_C_4EF30"
python3 "$TRIM" build/asm/disc1/3F758.s.o .text "$SIZE_3F758"
python3 "$TRIM" build/src/func_8004F2E4.c.o .text "$SIZE_C_4F2E4"
python3 "$TRIM" build/asm/disc1/3FB0C.s.o .text "$SIZE_3FB0C"
...
python3 "$TRIM" build/src/func_8004F950.c.o .text "$SIZE_C_4F950"
python3 "$TRIM" build/src/func_8004F978.c.o .text "$SIZE_C_4F978"
python3 "$TRIM" build/asm/disc1/401A0.s.o .text "$SIZE_401A0"
python3 "$TRIM" build/src/func_8004FF30.c.o .text "$SIZE_C_4FF30"
python3 "$TRIM" build/src/func_8004FF58.c.o .text "$SIZE_C_4FF58"
python3 "$TRIM" build/src/func_8004FF80.c.o .text "$SIZE_C_4FF80"
python3 "$TRIM" build/src/func_8004FFA8.c.o .text "$SIZE_C_4FFA8"
python3 "$TRIM" build/src/func_8004FFD0.c.o .text "$SIZE_C_4FFD0"
python3 "$TRIM" build/src/func_8004FFF8.c.o .text "$SIZE_C_4FFF8"
python3 "$TRIM" build/src/func_80050020.c.o .text "$SIZE_C_50020"
python3 "$TRIM" build/src/func_80050038.c.o .text "$SIZE_C_50038"
python3 "$TRIM" build/src/func_80050060.c.o .text "$SIZE_C_50060"
python3 "$TRIM" build/src/func_80050088.c.o .text "$SIZE_C_50088"
python3 "$TRIM" build/asm/disc1/408A8.s.o .text "$SIZE_408A8"
python3 "$TRIM" build/src/func_80050204.c.o .text "$SIZE_C_50204"
python3 "$TRIM" build/asm/disc1/40A2C.s.o .text "$SIZE_40A2C"
python3 "$TRIM" build/src/func_80050260.c.o .text "$SIZE_C_50260"
python3 "$TRIM" build/asm/disc1/40A80.s.o .text "$SIZE_40A80"
python3 "$TRIM" build/src/func_800506E8.c.o .text "$SIZE_C_506E8"
python3 "$TRIM" build/src/func_80050708.c.o .text "$SIZE_C_50708"
python3 "$TRIM" build/src/func_80050728.c.o .text "$SIZE_C_50728"
python3 "$TRIM" build/asm/disc1/40F48.s.o .text "$SIZE_40F48"
python3 "$TRIM" build/src/func_80050BE8.c.o .text "$SIZE_C_50BE8"
python3 "$TRIM" build/asm/disc1/41408.s.o .text "$SIZE_41408"
python3 "$TRIM" build/src/func_80050C50.c.o .text "$SIZE_C_50C50"
python3 "$TRIM" build/asm/disc1/41470.s.o .text "$SIZE_41470"
python3 "$TRIM" build/src/func_80050CF8.c.o .text "$SIZE_C_50CF8"
python3 "$TRIM" build/src/func_80050D18.c.o .text "$SIZE_C_50D18"
python3 "$TRIM" build/asm/disc1/41520.s.o .text "$SIZE_41520"
python3 "$TRIM" build/src/func_80051060.c.o .text "$SIZE_C_51060"
...
python3 "$TRIM" build/src/func_8005184C.c.o .text "$SIZE_C_5184C"
python3 "$TRIM" build/src/func_8005186C.c.o .text "$SIZE_C_5186C"
python3 "$TRIM" build/asm/disc1/420A8.s.o .text "$SIZE_420A8"
...
python3 "$TRIM" build/src/func_80052534.c.o .text "$SIZE_C_52534"
python3 "$TRIM" build/src/func_80052558.c.o .text "$SIZE_C_52558"
python3 "$TRIM" build/src/func_8005257C.c.o .text "$SIZE_C_5257C"
python3 "$TRIM" build/asm/disc1/42D94.s.o .text "$SIZE_42D94"
python3 "$TRIM" build/src/func_80052790.c.o .text "$SIZE_C_52790"
...
python3 "$TRIM" build/src/func_8005288C.c.o .text "$SIZE_C_5288C"
python3 "$TRIM" build/asm/disc1/43094.s.o .text "$SIZE_43094"
python3 "$TRIM" build/src/func_80052BCC.c.o .text "$SIZE_C_52BCC"
python3 "$TRIM" build/asm/disc1/43408.s.o .text "$SIZE_43408"
...
python3 "$TRIM" build/src/func_80055FB4.c.o .text "$SIZE_C_55FB4"
python3 "$TRIM" build/asm/disc1/467E0.s.o .text "$SIZE_467E0"
...
python3 "$TRIM" build/src/func_8005BEE8.c.o .text "$SIZE_C_5BEE8"
python3 "$TRIM" build/asm/disc1/4C708.s.o .text "$SIZE_4C708"
python3 "$TRIM" build/src/func_8005C488.c.o .text "$SIZE_C_5C488"
python3 "$TRIM" build/asm/disc1/4CC98.s.o .text "$SIZE_4CC98"
python3 "$TRIM" build/src/func_8005D970.c.o .text "$SIZE_C_5D970"
python3 "$TRIM" build/asm/disc1/4E194.s.o .text "$SIZE_4E194"
python3 "$TRIM" build/src/func_8005DADC.c.o .text "$SIZE_C_5DADC"
python3 "$TRIM" build/asm/disc1/4E2FC.s.o .text "$SIZE_4E2FC"
...
python3 "$TRIM" build/src/func_8005E8A4.c.o .text "$SIZE_C_5E8A4"
python3 "$TRIM" build/asm/disc1/4F0C4.s.o .text "$SIZE_4F0C4"
python3 "$TRIM" build/src/func_8005E968.c.o .text "$SIZE_C_5E968"
python3 "$TRIM" build/asm/disc1/4F188.s.o .text "$SIZE_4F188"
...
python3 "$TRIM" build/src/func_8005F594.c.o .text "$SIZE_C_5F594"
python3 "$TRIM" build/asm/disc1/4FDB8.s.o .text "$SIZE_4FDB8"
...
python3 "$TRIM" build/src/func_80062F1C.c.o .text "$SIZE_C_62F1C"
python3 "$TRIM" build/asm/disc1/5373C.s.o .text "$SIZE_5373C"
...
python3 "$TRIM" build/src/func_80064C30.c.o .text "$SIZE_C_64C30"
python3 "$TRIM" build/asm/disc1/55454.s.o .text "$SIZE_55454"
python3 "$TRIM" build/src/func_80064E90.c.o .text "$SIZE_C_64E90"
python3 "$TRIM" build/asm/disc1/556B4.s.o .text "$SIZE_556B4"
python3 "$TRIM" build/src/func_800653B8.c.o .text "$SIZE_C_653B8"
python3 "$TRIM" build/asm/disc1/55C00.s.o .text "$SIZE_55C00"
python3 "$TRIM" build/src/func_8006A5BC.c.o .text "$SIZE_C_6A5BC"
python3 "$TRIM" build/src/func_8006A64C.c.o .text "$SIZE_C_6A64C"
...
python3 "$TRIM" build/src/func_8006DB48.c.o .text "$SIZE_C_6DB48"
python3 "$TRIM" build/asm/disc1/5E39C.s.o .text "$SIZE_5E39C"
...
python3 "$TRIM" build/src/func_800749D8.c.o .text "$SIZE_C_749D8"
...
python3 "$TRIM" build/src/func_80077A64.c.o .text "$SIZE_C_77A64"
python3 "$TRIM" build/asm/disc1/682A0.s.o .text "$SIZE_682A0"
python3 "$TRIM" build/src/func_80077AA4.c.o .text "$SIZE_C_77AA4"
python3 "$TRIM" build/asm/disc1/682BC.s.o .text "$SIZE_682BC"
python3 "$TRIM" build/src/func_80077B04.c.o .text "$SIZE_C_77B04"
python3 "$TRIM" build/asm/disc1/6832C.s.o .text "$SIZE_6832C"
python3 "$TRIM" build/src/func_80077B34.c.o .text "$SIZE_C_77B34"
python3 "$TRIM" build/asm/disc1/6835C.s.o .text "$SIZE_6835C"
...
python3 "$TRIM" build/src/func_80077CB4.c.o .text "$SIZE_C_77CB4"
python3 "$TRIM" build/asm/disc1/684EC.s.o .text "$SIZE_684EC"
...
python3 "$TRIM" build/src/func_8007A88C.c.o .text "$SIZE_C_7A88C"
python3 "$TRIM" build/asm/disc1/6B0AC.s.o .text "$SIZE_6B0AC"
python3 "$TRIM" build/src/func_8007A8EC.c.o .text "$SIZE_C_7A8EC"
python3 "$TRIM" build/asm/disc1/6B110.s.o .text "$SIZE_6B110"
...
python3 "$TRIM" build/src/func_8007DD14.c.o .text "$SIZE_C_7DD14"
python3 "$TRIM" build/asm/disc1/6E538.s.o .text "$SIZE_6E538"
...
python3 "$TRIM" build/src/func_8007F788.c.o .text "$SIZE_C_7F788"
python3 "$TRIM" build/src/func_8007F7A8.c.o .text "$SIZE_C_7F7A8"
python3 "$TRIM" build/asm/disc1/6FFC8.s.o .text "$SIZE_6FFC8"
...
python3 "$TRIM" build/src/func_8007FC64.c.o .text "$SIZE_C_7FC64"
python3 "$TRIM" build/src/func_8007FC88.c.o .text "$SIZE_C_7FC88"
...
python3 "$TRIM" build/src/func_80080B04.c.o .text "$SIZE_C_80B04"
python3 "$TRIM" build/asm/disc1/71324.s.o .text "$SIZE_71324"
...
python3 "$TRIM" build/src/func_800813E8.c.o .text "$SIZE_C_813E8"
python3 "$TRIM" build/asm/disc1/71C08.s.o .text "$SIZE_71C08"
python3 "$TRIM" build/src/func_800816F4.c.o .text "$SIZE_C_816F4"
python3 "$TRIM" build/asm/disc1/71F14.s.o .text "$SIZE_71F14"
python3 "$TRIM" build/src/func_800822AC.c.o .text "$SIZE_C_822AC"
python3 "$TRIM" build/asm/disc1/72ABC.s.o .text "$SIZE_72ABC"
python3 "$TRIM" build/src/func_800824F0.c.o .text "$SIZE_C_824F0"
python3 "$TRIM" build/asm/disc1/72D14.s.o .text "$SIZE_72D14"
python3 "$TRIM" build/src/func_80082534.c.o .text "$SIZE_C_82534"
python3 "$TRIM" build/asm/disc1/72D54.s.o .text "$SIZE_72D54"
...
python3 "$TRIM" build/src/func_80083C20.c.o .text "$SIZE_C_83C20"
python3 "$TRIM" build/asm/disc1/7443C.s.o .text "$SIZE_7443C"
python3 "$TRIM" build/src/func_80083E50.c.o .text "$SIZE_C_83E50"
python3 "$TRIM" build/src/func_80083E70.c.o .text "$SIZE_C_83E70"
python3 "$TRIM" build/src/func_80083E84.c.o .text "$SIZE_C_83E84"
python3 "$TRIM" build/src/func_80083EA4.c.o .text "$SIZE_C_83EA4"
python3 "$TRIM" build/src/func_80083EC4.c.o .text "$SIZE_C_83EC4"
...
python3 "$TRIM" build/src/func_80084FC4.c.o .text "$SIZE_C_84FC4"
python3 "$TRIM" build/asm/disc1/757E4.s.o .text "$SIZE_757E4"
python3 "$TRIM" build/src/func_80085084.c.o .text "$SIZE_C_85084"
python3 "$TRIM" build/asm/disc1/75898.s.o .text "$SIZE_75898"
python3 "$TRIM" build/src/func_80085728.c.o .text "$SIZE_C_85728"
python3 "$TRIM" build/asm/disc1/75F44.s.o .text "$SIZE_75F44"
python3 "$TRIM" build/src/func_80085DC4.c.o .text "$SIZE_C_85DC4"
python3 "$TRIM" build/asm/disc1/765E8.s.o .text "$SIZE_765E8"
...
python3 "$TRIM" build/src/func_8008777C.c.o .text "$SIZE_C_8777C"
python3 "$TRIM" build/asm/disc1/77F98.s.o .text "$SIZE_77F98"
python3 "$TRIM" build/src/func_800877BC.c.o .text "$SIZE_C_877BC"
python3 "$TRIM" build/src/func_800877D4.c.o .text "$SIZE_C_877D4"
python3 "$TRIM" build/src/func_800877F0.c.o .text "$SIZE_C_877F0"
python3 "$TRIM" build/asm/disc1/7800C.s.o .text "$SIZE_7800C"
python3 "$TRIM" build/src/func_8008788C.c.o .text "$SIZE_C_8788C"
python3 "$TRIM" build/src/func_800878C0.c.o .text "$SIZE_C_878C0"
python3 "$TRIM" build/asm/disc1/780F0.s.o .text "$SIZE_780F0"
...
python3 "$TRIM" build/src/func_8009059C.c.o .text "$SIZE_C_9059C"
python3 "$TRIM" build/src/func_800905C4.c.o .text "$SIZE_C_905C4"
...
python3 "$TRIM" build/src/func_8009068C.c.o .text "$SIZE_C_9068C"
...
python3 "$TRIM" build/src/func_800C2AF0.c.o .text "$SIZE_C_C2AF0"
python3 "$TRIM" build/asm/disc1/B3310.s.o .text "$SIZE_B3310"
...
python3 "$TRIM" build/src/func_800C6EC0.c.o .text "$SIZE_C_C6EC0"
python3 "$TRIM" build/src/func_800C6ED8.c.o .text "$SIZE_C_C6ED8"
python3 "$TRIM" build/asm/disc1/B76E8.s.o .text "$SIZE_B76E8"
python3 "$TRIM" build/src/func_800C7D00.c.o .text "$SIZE_C_C7D00"
python3 "$TRIM" build/asm/disc1/B852C.s.o .text "$SIZE_B852C"
...
python3 "$TRIM" build/src/func_800C8C4C.c.o .text "$SIZE_C_C8C4C"
python3 "$TRIM" build/asm/disc1/B9480.s.o .text "$SIZE_B9480"
python3 "$TRIM" build/src/func_800C8E44.c.o .text "$SIZE_C_C8E44"
python3 "$TRIM" build/asm/disc1/B9670.s.o .text "$SIZE_B9670"
...
python3 "$TRIM" build/src/func_800C9A00.c.o .text "$SIZE_C_C9A00"
python3 "$TRIM" build/asm/disc1/BA234.s.o .text "$SIZE_BA234"
python3 "$TRIM" build/src/func_800C9B3C.c.o .text "$SIZE_C_C9B3C"
python3 "$TRIM" build/asm/disc1/BA368.s.o .text "$SIZE_BA368"
python3 "$TRIM" build/src/func_800C9C00.c.o .text "$SIZE_C_C9C00"
python3 "$TRIM" build/src/func_800C9C10.c.o .text "$SIZE_C_C9C10"
python3 "$TRIM" build/src/func_800C9C18.c.o .text "$SIZE_C_C9C18"
python3 "$TRIM" build/asm/disc1/BA420.s.o .text "$SIZE_BA420"
...
python3 "$TRIM" build/src/func_800CA6D4.c.o .text "$SIZE_C_CA6D4"
python3 "$TRIM" build/asm/disc1/BAF00.s.o .text "$SIZE_BAF00"
...
python3 "$TRIM" build/asm/disc1/BAFB8.s.o .text "$SIZE_BAFB8"
...
python3 "$TRIM" build/src/func_800CBBBC.c.o .text "$SIZE_C_CBBBC"
python3 "$TRIM" build/asm/disc1/BC3F0.s.o .text "$SIZE_BC3F0"
python3 "$TRIM" build/src/func_800CBEE0.c.o .text "$SIZE_C_CBEE0"
python3 "$TRIM" build/asm/disc1/BC70C.s.o .text "$SIZE_BC70C"
python3 "$TRIM" build/src/func_800CBFA4.c.o .text "$SIZE_C_CBFA4"
python3 "$TRIM" build/src/func_800CBFB4.c.o .text "$SIZE_C_CBFB4"
python3 "$TRIM" build/src/func_800CBFBC.c.o .text "$SIZE_C_CBFBC"
python3 "$TRIM" build/asm/disc1/BC7C4.s.o .text "$SIZE_BC7C4"
python3 "$TRIM" build/src/func_800CCEBC.c.o .text "$SIZE_C_CCEBC"
python3 "$TRIM" build/asm/disc1/BD6E8.s.o .text "$SIZE_BD6E8"
python3 "$TRIM" build/src/func_800CCF80.c.o .text "$SIZE_C_CCF80"
python3 "$TRIM" build/src/func_800CCF90.c.o .text "$SIZE_C_CCF90"
python3 "$TRIM" build/src/func_800CCF98.c.o .text "$SIZE_C_CCF98"
python3 "$TRIM" build/asm/disc1/BD7A0.s.o .text "$SIZE_BD7A0"
...
python3 "$TRIM" build/src/func_800CD89C.c.o .text "$SIZE_C_CD89C"
python3 "$TRIM" build/asm/disc1/BE0C8.s.o .text "$SIZE_BE0C8"
python3 "$TRIM" build/src/func_800CD960.c.o .text "$SIZE_C_CD960"
python3 "$TRIM" build/src/func_800CD970.c.o .text "$SIZE_C_CD970"
python3 "$TRIM" build/src/func_800CD978.c.o .text "$SIZE_C_CD978"
python3 "$TRIM" build/asm/disc1/BE180.s.o .text "$SIZE_BE180"
...
python3 "$TRIM" build/src/func_800CE118.c.o .text "$SIZE_C_CE118"
python3 "$TRIM" build/asm/disc1/BE944.s.o .text "$SIZE_BE944"
python3 "$TRIM" build/src/func_800CE1DC.c.o .text "$SIZE_C_CE1DC"
python3 "$TRIM" build/src/func_800CE1EC.c.o .text "$SIZE_C_CE1EC"
python3 "$TRIM" build/src/func_800CE1F4.c.o .text "$SIZE_C_CE1F4"
python3 "$TRIM" build/asm/disc1/BE9FC.s.o .text "$SIZE_BE9FC"
...
python3 "$TRIM" build/src/func_800CE470.c.o .text "$SIZE_C_CE470"
python3 "$TRIM" build/asm/disc1/BEC9C.s.o .text "$SIZE_BEC9C"
python3 "$TRIM" build/src/func_800CE870.c.o .text "$SIZE_C_CE870"
python3 "$TRIM" build/asm/disc1/BF0F0.s.o .text "$SIZE_BF0F0"
...
SECTIONS
{
    ...
    .main 0x80010000 : AT(0x800)
    {
        ...
        build/src/func_80012700.c.o(.text)
        ...
        build/src/func_80017EC4.c.o(.text)
        ...
        build/src/func_800182A0.c.o(.text)
        build/src/func_800182C0.c.o(.text)
        build/src/func_800182E0.c.o(.text)
        build/asm/disc1/8B00.s.o(.text)
        build/src/func_80018B00.c.o(.text)
        build/asm/disc1/9330.s.o(.text)
        build/src/func_80018B68.c.o(.text)
        build/asm/disc1/9398.s.o(.text)
        build/src/func_80018BC8.c.o(.text)
        build/src/func_80018BEC.c.o(.text)
        build/asm/disc1/9410.s.o(.text)
        build/src/func_80018C58.c.o(.text)
        ...
        build/src/func_80018E58.c.o(.text)
        build/asm/disc1/9684.s.o(.text)
        build/src/func_80018EB4.c.o(.text)
        build/src/func_80018EE0.c.o(.text)
        build/src/func_80018F0C.c.o(.text)
        build/src/func_80018F54.c.o(.text)
        build/asm/disc1/9774.s.o(.text)
        ...
        build/src/func_80019484.c.o(.text)
        build/asm/disc1/9CB0.s.o(.text)
        build/src/func_800197D0.c.o(.text)
        build/src/func_800197F0.c.o(.text)
        build/asm/disc1/A010.s.o(.text)
        ...
        build/src/func_80030640.c.o(.text)
        build/asm/disc1/20EE0.s.o(.text)
        build/src/func_80033A20.c.o(.text)
        build/src/func_80033A2C.c.o(.text)
        build/asm/disc1/24240.s.o(.text)
        build/src/func_800363F4.c.o(.text)
        build/asm/disc1/26C48.s.o(.text)
        build/src/func_80036E34.c.o(.text)
        build/src/func_80036E58.c.o(.text)
        build/asm/disc1/2767C.s.o(.text)
        build/src/func_800370A8.c.o(.text)
        build/asm/disc1/278BC.s.o(.text)
        build/src/func_800370DC.c.o(.text)
        build/src/func_80037140.c.o(.text)
        ...
        build/src/func_80037548.c.o(.text)
        ...
        build/src/func_80039970.c.o(.text)
        build/asm/disc1/2A19C.s.o(.text)
        ...
        build/src/func_8003E0D0.c.o(.text)
        build/asm/disc1/2E8FC.s.o(.text)
        build/src/func_8003E610.c.o(.text)
        build/src/func_8003E680.c.o(.text)
        build/asm/disc1/2EF54.s.o(.text)
        ...
        build/src/func_800471BC.c.o(.text)
        build/asm/disc1/379E4.s.o(.text)
        build/src/func_8004732C.c.o(.text)
        build/asm/disc1/37B54.s.o(.text)
        build/src/func_800474A8.c.o(.text)
        build/asm/disc1/37CD0.s.o(.text)
        build/src/func_8004B534.c.o(.text)
        build/src/func_8004B55C.c.o(.text)
        build/asm/disc1/3BD84.s.o(.text)
        build/src/func_8004BF08.c.o(.text)
        build/asm/disc1/3C740.s.o(.text)
        ...
        build/src/func_8004D4A0.c.o(.text)
        build/asm/disc1/3DCC4.s.o(.text)
        ...
        build/src/func_8004EF30.c.o(.text)
        build/asm/disc1/3F758.s.o(.text)
        build/src/func_8004F2E4.c.o(.text)
        build/asm/disc1/3FB0C.s.o(.text)
        ...
        build/src/func_8004F950.c.o(.text)
        build/src/func_8004F978.c.o(.text)
        build/asm/disc1/401A0.s.o(.text)
        build/src/func_8004FF30.c.o(.text)
        build/src/func_8004FF58.c.o(.text)
        build/src/func_8004FF80.c.o(.text)
        build/src/func_8004FFA8.c.o(.text)
        build/src/func_8004FFD0.c.o(.text)
        build/src/func_8004FFF8.c.o(.text)
        build/src/func_80050020.c.o(.text)
        build/src/func_80050038.c.o(.text)
        build/src/func_80050060.c.o(.text)
        build/src/func_80050088.c.o(.text)
        build/asm/disc1/408A8.s.o(.text)
        build/src/func_80050204.c.o(.text)
        build/asm/disc1/40A2C.s.o(.text)
        build/src/func_80050260.c.o(.text)
        build/asm/disc1/40A80.s.o(.text)
        build/src/func_800506E8.c.o(.text)
        build/src/func_80050708.c.o(.text)
        build/src/func_80050728.c.o(.text)
        build/asm/disc1/40F48.s.o(.text)
        build/src/func_80050BE8.c.o(.text)
        build/asm/disc1/41408.s.o(.text)
        build/src/func_80050C50.c.o(.text)
        build/asm/disc1/41470.s.o(.text)
        build/src/func_80050CF8.c.o(.text)
        build/src/func_80050D18.c.o(.text)
        build/asm/disc1/41520.s.o(.text)
        build/src/func_80051060.c.o(.text)
        ...
        build/src/func_8005184C.c.o(.text)
        build/src/func_8005186C.c.o(.text)
        build/asm/disc1/420A8.s.o(.text)
        ...
        build/src/func_80052534.c.o(.text)
        build/src/func_80052558.c.o(.text)
        build/src/func_8005257C.c.o(.text)
        build/asm/disc1/42D94.s.o(.text)
        build/src/func_80052790.c.o(.text)
        build/src/func_800527B4.c.o(.text)
        build/src/func_800527C0.c.o(.text)
        build/asm/disc1/42FC8.s.o(.text)
        build/src/func_8005288C.c.o(.text)
        build/asm/disc1/43094.s.o(.text)
        build/src/func_80052BCC.c.o(.text)
        build/asm/disc1/43408.s.o(.text)
        ...
        build/src/func_80055FB4.c.o(.text)
        build/asm/disc1/467E0.s.o(.text)
        ...
        build/src/func_8005BEE8.c.o(.text)
        build/asm/disc1/4C708.s.o(.text)
        build/src/func_8005C488.c.o(.text)
        build/asm/disc1/4CC98.s.o(.text)
        build/src/func_8005D970.c.o(.text)
        build/asm/disc1/4E194.s.o(.text)
        build/src/func_8005DADC.c.o(.text)
        build/asm/disc1/4E2FC.s.o(.text)
        ...
        build/src/func_8005E8A4.c.o(.text)
        build/asm/disc1/4F0C4.s.o(.text)
        build/src/func_8005E968.c.o(.text)
        build/asm/disc1/4F188.s.o(.text)
        ...
        build/src/func_8005F594.c.o(.text)
        build/asm/disc1/4FDB8.s.o(.text)
        ...
        build/src/func_80062F1C.c.o(.text)
        build/asm/disc1/5373C.s.o(.text)
        ...
        build/src/func_80064C30.c.o(.text)
        build/asm/disc1/55454.s.o(.text)
        build/src/func_80064E90.c.o(.text)
        build/asm/disc1/556B4.s.o(.text)
        build/src/func_800653B8.c.o(.text)
        build/asm/disc1/55C00.s.o(.text)
        build/src/func_8006A5BC.c.o(.text)
        build/src/func_8006A64C.c.o(.text)
        build/src/func_8006A674.c.o(.text)
        build/src/func_8006A8D4.c.o(.text)
        build/asm/disc1/5B1E4.s.o(.text)
        build/src/func_8006DB48.c.o(.text)
        build/asm/disc1/5E39C.s.o(.text)
        ...
        build/src/func_800749D8.c.o(.text)
        ...
        build/src/func_80077A64.c.o(.text)
        build/asm/disc1/682A0.s.o(.text)
        build/src/func_80077AA4.c.o(.text)
        build/asm/disc1/682BC.s.o(.text)
        build/src/func_80077B04.c.o(.text)
        build/asm/disc1/6832C.s.o(.text)
        build/src/func_80077B34.c.o(.text)
        build/asm/disc1/6835C.s.o(.text)
        ...
        build/src/func_80077CB4.c.o(.text)
        build/asm/disc1/684EC.s.o(.text)
        ...
        build/src/func_8007A88C.c.o(.text)
        build/asm/disc1/6B0AC.s.o(.text)
        build/src/func_8007A8EC.c.o(.text)
        build/asm/disc1/6B110.s.o(.text)
        ...
        build/src/func_8007DD14.c.o(.text)
        build/asm/disc1/6E538.s.o(.text)
        ...
        build/src/func_8007F788.c.o(.text)
        build/src/func_8007F7A8.c.o(.text)
        build/asm/disc1/6FFC8.s.o(.text)
        ...
        build/src/func_8007FC64.c.o(.text)
        build/src/func_8007FC88.c.o(.text)
        ...
        build/src/func_80080B04.c.o(.text)
        build/asm/disc1/71324.s.o(.text)
        ...
        build/src/func_800813E8.c.o(.text)
        build/asm/disc1/71C08.s.o(.text)
        build/src/func_800816F4.c.o(.text)
        build/asm/disc1/71F14.s.o(.text)
        build/src/func_800822AC.c.o(.text)
        build/asm/disc1/72ABC.s.o(.text)
        build/src/func_800824F0.c.o(.text)
        build/asm/disc1/72D14.s.o(.text)
        build/src/func_80082534.c.o(.text)
        build/asm/disc1/72D54.s.o(.text)
        ...
        build/src/func_80083C20.c.o(.text)
        build/asm/disc1/7443C.s.o(.text)
        build/src/func_80083E50.c.o(.text)
        build/src/func_80083E70.c.o(.text)
        build/src/func_80083E84.c.o(.text)
        build/src/func_80083EA4.c.o(.text)
        build/src/func_80083EC4.c.o(.text)
        ...
        build/src/func_80084FC4.c.o(.text)
        build/asm/disc1/757E4.s.o(.text)
        build/src/func_80085084.c.o(.text)
        build/asm/disc1/75898.s.o(.text)
        build/src/func_80085728.c.o(.text)
        build/asm/disc1/75F44.s.o(.text)
        build/src/func_80085DC4.c.o(.text)
        build/asm/disc1/765E8.s.o(.text)
        ...
        build/src/func_8008777C.c.o(.text)
        build/asm/disc1/77F98.s.o(.text)
        build/src/func_800877BC.c.o(.text)
        build/src/func_800877D4.c.o(.text)
        build/src/func_800877F0.c.o(.text)
        build/asm/disc1/7800C.s.o(.text)
        build/src/func_8008788C.c.o(.text)
        build/src/func_800878C0.c.o(.text)
        build/asm/disc1/780F0.s.o(.text)
        ...
        build/src/func_8009059C.c.o(.text)
        build/src/func_800905C4.c.o(.text)
        ...
        build/src/func_8009068C.c.o(.text)
        ...
        build/src/func_800C2AF0.c.o(.text)
        build/asm/disc1/B3310.s.o(.text)
        build/src/func_800C2B40.c.o(.text)
        build/src/func_800C2B50.c.o(.text)
        build/asm/disc1/B3368.s.o(.text)
        build/src/func_800C6EC0.c.o(.text)
        build/src/func_800C6ED8.c.o(.text)
        build/asm/disc1/B76E8.s.o(.text)
        build/src/func_800C7D00.c.o(.text)
        build/asm/disc1/B852C.s.o(.text)
        ...
        build/src/func_800C8C4C.c.o(.text)
        build/asm/disc1/B9480.s.o(.text)
        build/src/func_800C8E44.c.o(.text)
        build/asm/disc1/B9670.s.o(.text)
        ...
        build/src/func_800C9A00.c.o(.text)
        build/asm/disc1/BA234.s.o(.text)
        build/src/func_800C9B3C.c.o(.text)
        build/asm/disc1/BA368.s.o(.text)
        build/src/func_800C9C00.c.o(.text)
        build/src/func_800C9C10.c.o(.text)
        build/src/func_800C9C18.c.o(.text)
        build/asm/disc1/BA420.s.o(.text)
        ...
        build/src/func_800CBBBC.c.o(.text)
        build/asm/disc1/BC3F0.s.o(.text)
        build/src/func_800CBEE0.c.o(.text)
        build/asm/disc1/BC70C.s.o(.text)
        build/src/func_800CBFA4.c.o(.text)
        build/src/func_800CBFB4.c.o(.text)
        build/src/func_800CBFBC.c.o(.text)
        build/asm/disc1/BC7C4.s.o(.text)
        build/src/func_800CCEBC.c.o(.text)
        build/asm/disc1/BD6E8.s.o(.text)
        build/src/func_800CCF80.c.o(.text)
        build/src/func_800CCF90.c.o(.text)
        build/src/func_800CCF98.c.o(.text)
        build/asm/disc1/BD7A0.s.o(.text)
        ...
        build/src/func_800CD89C.c.o(.text)
        build/asm/disc1/BE0C8.s.o(.text)
        build/src/func_800CD960.c.o(.text)
        build/src/func_800CD970.c.o(.text)
        build/src/func_800CD978.c.o(.text)
        build/asm/disc1/BE180.s.o(.text)
        ...
        build/src/func_800CE118.c.o(.text)
        build/asm/disc1/BE944.s.o(.text)
        build/src/func_800CE1DC.c.o(.text)
        build/src/func_800CE1EC.c.o(.text)
        build/src/func_800CE1F4.c.o(.text)
        build/asm/disc1/BE9FC.s.o(.text)
        build/src/func_800CE3AC.c.o(.text)
        build/asm/disc1/BEBB4.s.o(.text)
        build/src/func_800CE464.c.o(.text)
        build/src/func_800CE470.c.o(.text)
        build/asm/disc1/BEC9C.s.o(.text)
        build/src/func_800CE870.c.o(.text)
        build/asm/disc1/BF0F0.s.o(.text)
        ...
        build/src/func_80012700.c.o(.data)
        ...
        build/src/func_80017EC4.c.o(.data)
        ...
        build/src/func_800182A0.c.o(.data)
        build/src/func_800182C0.c.o(.data)
        build/src/func_800182E0.c.o(.data)
        build/asm/disc1/8B00.s.o(.data)
        build/src/func_80018B00.c.o(.data)
        build/asm/disc1/9330.s.o(.data)
        build/src/func_80018B68.c.o(.data)
        build/asm/disc1/9398.s.o(.data)
        build/src/func_80018BC8.c.o(.data)
        build/src/func_80018BEC.c.o(.data)
        build/asm/disc1/9410.s.o(.data)
        build/src/func_80018C58.c.o(.data)
        ...
        build/src/func_80018E58.c.o(.data)
        build/asm/disc1/9684.s.o(.data)
        build/src/func_80018EB4.c.o(.data)
        build/src/func_80018EE0.c.o(.data)
        build/src/func_80018F0C.c.o(.data)
        build/src/func_80018F54.c.o(.data)
        build/asm/disc1/9774.s.o(.data)
        ...
        build/src/func_80019484.c.o(.data)
        build/asm/disc1/9CB0.s.o(.data)
        build/src/func_800197D0.c.o(.data)
        build/src/func_800197F0.c.o(.data)
        build/asm/disc1/A010.s.o(.data)
        ...
        build/src/func_80030640.c.o(.data)
        build/asm/disc1/20EE0.s.o(.data)
        build/src/func_80033A20.c.o(.data)
        build/src/func_80033A2C.c.o(.data)
        build/asm/disc1/24240.s.o(.data)
        build/src/func_800363F4.c.o(.data)
        build/asm/disc1/26C48.s.o(.data)
        build/src/func_80036E34.c.o(.data)
        build/src/func_80036E58.c.o(.data)
        build/asm/disc1/2767C.s.o(.data)
        build/src/func_800370A8.c.o(.data)
        build/asm/disc1/278BC.s.o(.data)
        build/src/func_800370DC.c.o(.data)
        build/src/func_80037140.c.o(.data)
        ...
        build/src/func_80037548.c.o(.data)
        ...
        build/src/func_80039970.c.o(.data)
        build/asm/disc1/2A19C.s.o(.data)
        ...
        build/src/func_8003E0D0.c.o(.data)
        build/asm/disc1/2E8FC.s.o(.data)
        build/src/func_8003E610.c.o(.data)
        build/src/func_8003E680.c.o(.data)
        build/asm/disc1/2EF54.s.o(.data)
        ...
        build/src/func_800471BC.c.o(.data)
        build/asm/disc1/379E4.s.o(.data)
        build/src/func_8004732C.c.o(.data)
        build/asm/disc1/37B54.s.o(.data)
        build/src/func_800474A8.c.o(.data)
        build/asm/disc1/37CD0.s.o(.data)
        build/src/func_8004B534.c.o(.data)
        build/src/func_8004B55C.c.o(.data)
        build/asm/disc1/3BD84.s.o(.data)
        build/src/func_8004BF08.c.o(.data)
        build/asm/disc1/3C740.s.o(.data)
        ...
        build/src/func_8004D4A0.c.o(.data)
        build/asm/disc1/3DCC4.s.o(.data)
        ...
        build/src/func_8004EF30.c.o(.data)
        build/asm/disc1/3F758.s.o(.data)
        build/src/func_8004F2E4.c.o(.data)
        build/asm/disc1/3FB0C.s.o(.data)
        ...
        build/src/func_8004F950.c.o(.data)
        build/src/func_8004F978.c.o(.data)
        build/asm/disc1/401A0.s.o(.data)
        build/src/func_8004FF30.c.o(.data)
        build/src/func_8004FF58.c.o(.data)
        build/src/func_8004FF80.c.o(.data)
        build/src/func_8004FFA8.c.o(.data)
        build/src/func_8004FFD0.c.o(.data)
        build/src/func_8004FFF8.c.o(.data)
        build/src/func_80050020.c.o(.data)
        build/src/func_80050038.c.o(.data)
        build/src/func_80050060.c.o(.data)
        build/src/func_80050088.c.o(.data)
        build/asm/disc1/408A8.s.o(.data)
        build/src/func_80050204.c.o(.data)
        build/asm/disc1/40A2C.s.o(.data)
        build/src/func_80050260.c.o(.data)
        build/asm/disc1/40A80.s.o(.data)
        build/src/func_800506E8.c.o(.data)
        build/src/func_80050708.c.o(.data)
        build/src/func_80050728.c.o(.data)
        build/asm/disc1/40F48.s.o(.data)
        build/src/func_80050BE8.c.o(.data)
        build/asm/disc1/41408.s.o(.data)
        build/src/func_80050C50.c.o(.data)
        build/asm/disc1/41470.s.o(.data)
        build/src/func_80050CF8.c.o(.data)
        build/src/func_80050D18.c.o(.data)
        build/asm/disc1/41520.s.o(.data)
        build/src/func_80051060.c.o(.data)
        ...
        build/src/func_8005184C.c.o(.data)
        build/src/func_8005186C.c.o(.data)
        build/asm/disc1/420A8.s.o(.data)
        ...
        build/src/func_80052534.c.o(.data)
        build/src/func_80052558.c.o(.data)
        build/src/func_8005257C.c.o(.data)
        build/asm/disc1/42D94.s.o(.data)
        build/src/func_80052790.c.o(.data)
        build/src/func_800527B4.c.o(.data)
        build/src/func_800527C0.c.o(.data)
        build/asm/disc1/42FC8.s.o(.data)
        build/src/func_8005288C.c.o(.data)
        build/asm/disc1/43094.s.o(.data)
        ...
        build/src/func_80055FB4.c.o(.data)
        build/asm/disc1/467E0.s.o(.data)
        ...
        build/src/func_8005BEE8.c.o(.data)
        build/asm/disc1/4C708.s.o(.data)
        build/src/func_8005C488.c.o(.data)
        build/asm/disc1/4CC98.s.o(.data)
        build/src/func_8005D970.c.o(.data)
        build/asm/disc1/4E194.s.o(.data)
        build/src/func_8005DADC.c.o(.data)
        build/asm/disc1/4E2FC.s.o(.data)
        ...
        build/src/func_8005E8A4.c.o(.data)
        build/asm/disc1/4F0C4.s.o(.data)
        build/src/func_8005E968.c.o(.data)
        build/asm/disc1/4F188.s.o(.data)
        ...
        build/src/func_8005F594.c.o(.data)
        build/asm/disc1/4FDB8.s.o(.data)
        ...
        build/src/func_80062F1C.c.o(.data)
        build/asm/disc1/5373C.s.o(.data)
        ...
        build/src/func_80064C30.c.o(.data)
        build/asm/disc1/55454.s.o(.data)
        build/src/func_80064E90.c.o(.data)
        build/asm/disc1/556B4.s.o(.data)
        build/src/func_800653B8.c.o(.data)
        build/asm/disc1/55C00.s.o(.data)
        build/src/func_8006A5BC.c.o(.data)
        build/src/func_8006A64C.c.o(.data)
        build/src/func_8006A674.c.o(.data)
        build/src/func_8006A8D4.c.o(.data)
        build/asm/disc1/5B1E4.s.o(.data)
        build/src/func_8006DB48.c.o(.data)
        build/asm/disc1/5E39C.s.o(.data)
        ...
        build/src/func_800749D8.c.o(.data)
        ...
        build/src/func_80077A64.c.o(.data)
        build/asm/disc1/682A0.s.o(.data)
        build/src/func_80077AA4.c.o(.data)
        build/asm/disc1/682BC.s.o(.data)
        build/src/func_80077B04.c.o(.data)
        build/asm/disc1/6832C.s.o(.data)
        build/src/func_80077B34.c.o(.data)
        build/asm/disc1/6835C.s.o(.data)
        ...
        build/src/func_80077CB4.c.o(.data)
        build/asm/disc1/684EC.s.o(.data)
        ...
        build/src/func_8007A88C.c.o(.data)
        build/asm/disc1/6B0AC.s.o(.data)
        build/src/func_8007A8EC.c.o(.data)
        build/asm/disc1/6B110.s.o(.data)
        ...
        build/src/func_8007DD14.c.o(.data)
        build/asm/disc1/6E538.s.o(.data)
        ...
        build/src/func_8007F788.c.o(.data)
        build/src/func_8007F7A8.c.o(.data)
        build/asm/disc1/6FFC8.s.o(.data)
        ...
        build/src/func_8007FC64.c.o(.data)
        build/src/func_8007FC88.c.o(.data)
        ...
        build/src/func_80080B04.c.o(.data)
        build/asm/disc1/71324.s.o(.data)
        ...
        build/src/func_800813E8.c.o(.data)
        build/asm/disc1/71C08.s.o(.data)
        build/src/func_800816F4.c.o(.data)
        build/asm/disc1/71F14.s.o(.data)
        build/src/func_800822AC.c.o(.data)
        build/asm/disc1/72ABC.s.o(.data)
        build/src/func_800824F0.c.o(.data)
        build/asm/disc1/72D14.s.o(.data)
        build/src/func_80082534.c.o(.data)
        build/asm/disc1/72D54.s.o(.data)
        ...
        build/src/func_80083C20.c.o(.data)
        build/asm/disc1/7443C.s.o(.data)
        build/src/func_80083E50.c.o(.data)
        build/src/func_80083E70.c.o(.data)
        build/src/func_80083E84.c.o(.data)
        build/src/func_80083EA4.c.o(.data)
        build/src/func_80083EC4.c.o(.data)
        ...
        build/src/func_80084FC4.c.o(.data)
        build/asm/disc1/757E4.s.o(.data)
        build/src/func_80085084.c.o(.data)
        build/asm/disc1/75898.s.o(.data)
        build/src/func_80085728.c.o(.data)
        build/asm/disc1/75F44.s.o(.data)
        build/src/func_80085DC4.c.o(.data)
        build/asm/disc1/765E8.s.o(.data)
        ...
        build/src/func_8008777C.c.o(.data)
        build/asm/disc1/77F98.s.o(.data)
        build/src/func_800877BC.c.o(.data)
        build/src/func_800877D4.c.o(.data)
        build/src/func_800877F0.c.o(.data)
        build/asm/disc1/7800C.s.o(.data)
        build/src/func_8008788C.c.o(.data)
        build/src/func_800878C0.c.o(.data)
        build/asm/disc1/780F0.s.o(.data)
        ...
        build/src/func_8009059C.c.o(.data)
        build/src/func_800905C4.c.o(.data)
        ...
        build/src/func_8009068C.c.o(.data)
        ...
        build/src/func_800C2AF0.c.o(.data)
        build/asm/disc1/B3310.s.o(.data)
        build/src/func_800C2B40.c.o(.data)
        build/src/func_800C2B50.c.o(.data)
        build/asm/disc1/B3368.s.o(.data)
        build/src/func_800C6EC0.c.o(.data)
        build/src/func_800C6ED8.c.o(.data)
        build/asm/disc1/B76E8.s.o(.data)
        build/src/func_800C7D00.c.o(.data)
        build/asm/disc1/B852C.s.o(.data)
        ...
        build/src/func_800C8C4C.c.o(.data)
        build/asm/disc1/B9480.s.o(.data)
        build/src/func_800C8E44.c.o(.data)
        build/asm/disc1/B9670.s.o(.data)
        ...
        build/src/func_800C9A00.c.o(.data)
        build/asm/disc1/BA234.s.o(.data)
        build/src/func_800C9B3C.c.o(.data)
        build/asm/disc1/BA368.s.o(.data)
        build/src/func_800C9C00.c.o(.data)
        build/src/func_800C9C10.c.o(.data)
        build/src/func_800C9C18.c.o(.data)
        build/asm/disc1/BA420.s.o(.data)
        ...
        build/src/func_800CBBBC.c.o(.data)
        build/asm/disc1/BC3F0.s.o(.data)
        build/src/func_800CBEE0.c.o(.data)
        build/asm/disc1/BC70C.s.o(.data)
        build/src/func_800CBFA4.c.o(.data)
        build/src/func_800CBFB4.c.o(.data)
        build/src/func_800CBFBC.c.o(.data)
        build/asm/disc1/BC7C4.s.o(.data)
        build/src/func_800CCEBC.c.o(.data)
        build/asm/disc1/BD6E8.s.o(.data)
        build/src/func_800CCF80.c.o(.data)
        build/src/func_800CCF90.c.o(.data)
        build/src/func_800CCF98.c.o(.data)
        build/asm/disc1/BD7A0.s.o(.data)
        ...
        build/src/func_800CD89C.c.o(.data)
        build/asm/disc1/BE0C8.s.o(.data)
        build/src/func_800CD960.c.o(.data)
        build/src/func_800CD970.c.o(.data)
        build/src/func_800CD978.c.o(.data)
        build/asm/disc1/BE180.s.o(.data)
        ...
        build/src/func_800CE118.c.o(.data)
        build/asm/disc1/BE944.s.o(.data)
        build/src/func_800CE1DC.c.o(.data)
        build/src/func_800CE1EC.c.o(.data)
        build/src/func_800CE1F4.c.o(.data)
        build/asm/disc1/BE9FC.s.o(.data)
        build/src/func_800CE3AC.c.o(.data)
        build/asm/disc1/BEBB4.s.o(.data)
        build/src/func_800CE464.c.o(.data)
        build/src/func_800CE470.c.o(.data)
        build/asm/disc1/BEC9C.s.o(.data)
        build/src/func_800CE870.c.o(.data)
        build/asm/disc1/BF0F0.s.o(.data)
        ...
        build/src/func_80012700.c.o(.rodata)
        ...
        build/src/func_80017EC4.c.o(.rodata)
        ...
        build/src/func_800182A0.c.o(.rodata)
        build/src/func_800182C0.c.o(.rodata)
        build/src/func_800182E0.c.o(.rodata)
        build/asm/disc1/8B00.s.o(.rodata)
        build/src/func_80018B00.c.o(.rodata)
        build/asm/disc1/9330.s.o(.rodata)
        build/src/func_80018B68.c.o(.rodata)
        build/asm/disc1/9398.s.o(.rodata)
        build/src/func_80018BC8.c.o(.rodata)
        build/src/func_80018BEC.c.o(.rodata)
        build/asm/disc1/9410.s.o(.rodata)
        build/src/func_80018C58.c.o(.rodata)
        ...
        build/src/func_80018E58.c.o(.rodata)
        build/asm/disc1/9684.s.o(.rodata)
        build/src/func_80018EB4.c.o(.rodata)
        build/src/func_80018EE0.c.o(.rodata)
        build/src/func_80018F0C.c.o(.rodata)
        build/src/func_80018F54.c.o(.rodata)
        build/asm/disc1/9774.s.o(.rodata)
        ...
        build/src/func_80019484.c.o(.rodata)
        build/asm/disc1/9CB0.s.o(.rodata)
        build/src/func_800197D0.c.o(.rodata)
        build/src/func_800197F0.c.o(.rodata)
        build/asm/disc1/A010.s.o(.rodata)
        ...
        build/src/func_80030640.c.o(.rodata)
        build/asm/disc1/20EE0.s.o(.rodata)
        build/src/func_80033A20.c.o(.rodata)
        build/src/func_80033A2C.c.o(.rodata)
        build/asm/disc1/24240.s.o(.rodata)
        build/src/func_800363F4.c.o(.rodata)
        build/asm/disc1/26C48.s.o(.rodata)
        build/src/func_80036E34.c.o(.rodata)
        build/src/func_80036E58.c.o(.rodata)
        build/asm/disc1/2767C.s.o(.rodata)
        build/src/func_800370A8.c.o(.rodata)
        build/asm/disc1/278BC.s.o(.rodata)
        build/src/func_800370DC.c.o(.rodata)
        build/src/func_80037140.c.o(.rodata)
        ...
        build/src/func_80037548.c.o(.rodata)
        ...
        build/src/func_80039970.c.o(.rodata)
        build/asm/disc1/2A19C.s.o(.rodata)
        ...
        build/src/func_8003E0D0.c.o(.rodata)
        build/asm/disc1/2E8FC.s.o(.rodata)
        build/src/func_8003E610.c.o(.rodata)
        build/src/func_8003E680.c.o(.rodata)
        build/asm/disc1/2EF54.s.o(.rodata)
        ...
        build/src/func_800471BC.c.o(.rodata)
        build/asm/disc1/379E4.s.o(.rodata)
        build/src/func_8004732C.c.o(.rodata)
        build/asm/disc1/37B54.s.o(.rodata)
        build/src/func_800474A8.c.o(.rodata)
        build/asm/disc1/37CD0.s.o(.rodata)
        build/src/func_8004B534.c.o(.rodata)
        build/src/func_8004B55C.c.o(.rodata)
        build/asm/disc1/3BD84.s.o(.rodata)
        build/src/func_8004BF08.c.o(.rodata)
        build/asm/disc1/3C740.s.o(.rodata)
        ...
        build/src/func_8004D4A0.c.o(.rodata)
        build/asm/disc1/3DCC4.s.o(.rodata)
        ...
        build/src/func_8004EF30.c.o(.rodata)
        build/asm/disc1/3F758.s.o(.rodata)
        build/src/func_8004F2E4.c.o(.rodata)
        build/asm/disc1/3FB0C.s.o(.rodata)
        ...
        build/src/func_8004F950.c.o(.rodata)
        build/src/func_8004F978.c.o(.rodata)
        build/asm/disc1/401A0.s.o(.rodata)
        build/src/func_8004FF30.c.o(.rodata)
        build/src/func_8004FF58.c.o(.rodata)
        build/src/func_8004FF80.c.o(.rodata)
        build/src/func_8004FFA8.c.o(.rodata)
        build/src/func_8004FFD0.c.o(.rodata)
        build/src/func_8004FFF8.c.o(.rodata)
        build/src/func_80050020.c.o(.rodata)
        build/src/func_80050038.c.o(.rodata)
        build/src/func_80050060.c.o(.rodata)
        build/src/func_80050088.c.o(.rodata)
        build/asm/disc1/408A8.s.o(.rodata)
        build/src/func_80050204.c.o(.rodata)
        build/asm/disc1/40A2C.s.o(.rodata)
        build/src/func_80050260.c.o(.rodata)
        build/asm/disc1/40A80.s.o(.rodata)
        build/src/func_800506E8.c.o(.rodata)
        build/src/func_80050708.c.o(.rodata)
        build/src/func_80050728.c.o(.rodata)
        build/asm/disc1/40F48.s.o(.rodata)
        build/src/func_80050BE8.c.o(.rodata)
        build/asm/disc1/41408.s.o(.rodata)
        build/src/func_80050C50.c.o(.rodata)
        build/asm/disc1/41470.s.o(.rodata)
        build/src/func_80050CF8.c.o(.rodata)
        build/src/func_80050D18.c.o(.rodata)
        build/asm/disc1/41520.s.o(.rodata)
        build/src/func_80051060.c.o(.rodata)
        ...
        build/src/func_8005184C.c.o(.rodata)
        build/src/func_8005186C.c.o(.rodata)
        build/asm/disc1/420A8.s.o(.rodata)
        ...
        build/src/func_80052534.c.o(.rodata)
        build/src/func_80052558.c.o(.rodata)
        build/src/func_8005257C.c.o(.rodata)
        build/asm/disc1/42D94.s.o(.rodata)
        build/src/func_80052790.c.o(.rodata)
        build/src/func_800527B4.c.o(.rodata)
        build/src/func_800527C0.c.o(.rodata)
        build/asm/disc1/42FC8.s.o(.rodata)
        build/src/func_8005288C.c.o(.rodata)
        build/asm/disc1/43094.s.o(.rodata)
        ...
        build/src/func_80055FB4.c.o(.rodata)
        build/asm/disc1/467E0.s.o(.rodata)
        ...
        build/src/func_8005BEE8.c.o(.rodata)
        build/asm/disc1/4C708.s.o(.rodata)
        build/src/func_8005C488.c.o(.rodata)
        build/asm/disc1/4CC98.s.o(.rodata)
        build/src/func_8005D970.c.o(.rodata)
        build/asm/disc1/4E194.s.o(.rodata)
        build/src/func_8005DADC.c.o(.rodata)
        build/asm/disc1/4E2FC.s.o(.rodata)
        ...
        build/src/func_8005E8A4.c.o(.rodata)
        build/asm/disc1/4F0C4.s.o(.rodata)
        build/src/func_8005E968.c.o(.rodata)
        build/asm/disc1/4F188.s.o(.rodata)
        ...
        build/src/func_8005F594.c.o(.rodata)
        build/asm/disc1/4FDB8.s.o(.rodata)
        ...
        build/src/func_80062F1C.c.o(.rodata)
        build/asm/disc1/5373C.s.o(.rodata)
        ...
        build/src/func_80064C30.c.o(.rodata)
        build/asm/disc1/55454.s.o(.rodata)
        build/src/func_80064E90.c.o(.rodata)
        build/asm/disc1/556B4.s.o(.rodata)
        build/src/func_800653B8.c.o(.rodata)
        build/asm/disc1/55C00.s.o(.rodata)
        build/src/func_8006A5BC.c.o(.rodata)
        build/src/func_8006A64C.c.o(.rodata)
        build/src/func_8006A674.c.o(.rodata)
        build/src/func_8006A8D4.c.o(.rodata)
        build/asm/disc1/5B1E4.s.o(.rodata)
        build/src/func_8006DB48.c.o(.rodata)
        build/asm/disc1/5E39C.s.o(.rodata)
        ...
        build/src/func_800749D8.c.o(.rodata)
        ...
        build/src/func_80077A64.c.o(.rodata)
        build/asm/disc1/682A0.s.o(.rodata)
        build/src/func_80077AA4.c.o(.rodata)
        build/asm/disc1/682BC.s.o(.rodata)
        build/src/func_80077B04.c.o(.rodata)
        build/asm/disc1/6832C.s.o(.rodata)
        build/src/func_80077B34.c.o(.rodata)
        build/asm/disc1/6835C.s.o(.rodata)
        ...
        build/src/func_80077CB4.c.o(.rodata)
        build/asm/disc1/684EC.s.o(.rodata)
        ...
        build/src/func_8007A88C.c.o(.rodata)
        build/asm/disc1/6B0AC.s.o(.rodata)
        build/src/func_8007A8EC.c.o(.rodata)
        build/asm/disc1/6B110.s.o(.rodata)
        ...
        build/src/func_8007DD14.c.o(.rodata)
        build/asm/disc1/6E538.s.o(.rodata)
        ...
        build/src/func_8007F788.c.o(.rodata)
        build/src/func_8007F7A8.c.o(.rodata)
        build/asm/disc1/6FFC8.s.o(.rodata)
        ...
        build/src/func_8007FC64.c.o(.rodata)
        build/src/func_8007FC88.c.o(.rodata)
        ...
        build/src/func_80080B04.c.o(.rodata)
        build/asm/disc1/71324.s.o(.rodata)
        ...
        build/src/func_800813E8.c.o(.rodata)
        build/asm/disc1/71C08.s.o(.rodata)
        build/src/func_800816F4.c.o(.rodata)
        build/asm/disc1/71F14.s.o(.rodata)
        build/src/func_800822AC.c.o(.rodata)
        build/asm/disc1/72ABC.s.o(.rodata)
        build/src/func_800824F0.c.o(.rodata)
        build/asm/disc1/72D14.s.o(.rodata)
        build/src/func_80082534.c.o(.rodata)
        build/asm/disc1/72D54.s.o(.rodata)
        ...
        build/src/func_80083C20.c.o(.rodata)
        build/asm/disc1/7443C.s.o(.rodata)
        build/src/func_80083E50.c.o(.rodata)
        build/src/func_80083E70.c.o(.rodata)
        build/src/func_80083E84.c.o(.rodata)
        build/src/func_80083EA4.c.o(.rodata)
        build/src/func_80083EC4.c.o(.rodata)
        ...
        build/src/func_80084FC4.c.o(.rodata)
        build/asm/disc1/757E4.s.o(.rodata)
        build/src/func_80085084.c.o(.rodata)
        build/asm/disc1/75898.s.o(.rodata)
        build/src/func_80085728.c.o(.rodata)
        build/asm/disc1/75F44.s.o(.rodata)
        build/src/func_80085DC4.c.o(.rodata)
        build/asm/disc1/765E8.s.o(.rodata)
        ...
        build/src/func_8008777C.c.o(.rodata)
        build/asm/disc1/77F98.s.o(.rodata)
        build/src/func_800877BC.c.o(.rodata)
        build/src/func_800877D4.c.o(.rodata)
        build/src/func_800877F0.c.o(.rodata)
        build/asm/disc1/7800C.s.o(.rodata)
        build/src/func_8008788C.c.o(.rodata)
        build/src/func_800878C0.c.o(.rodata)
        build/asm/disc1/780F0.s.o(.rodata)
        ...
        build/src/func_8009059C.c.o(.rodata)
        build/src/func_800905C4.c.o(.rodata)
        ...
        build/src/func_8009068C.c.o(.rodata)
        ...
        build/src/func_800C2AF0.c.o(.rodata)
        build/asm/disc1/B3310.s.o(.rodata)
        build/src/func_800C2B40.c.o(.rodata)
        build/src/func_800C2B50.c.o(.rodata)
        build/asm/disc1/B3368.s.o(.rodata)
        build/src/func_800C6EC0.c.o(.rodata)
        build/src/func_800C6ED8.c.o(.rodata)
        build/asm/disc1/B76E8.s.o(.rodata)
        build/src/func_800C7D00.c.o(.rodata)
        build/asm/disc1/B852C.s.o(.rodata)
        ...
        build/src/func_800C8C4C.c.o(.rodata)
        build/asm/disc1/B9480.s.o(.rodata)
        build/src/func_800C8E44.c.o(.rodata)
        build/asm/disc1/B9670.s.o(.rodata)
        ...
        build/src/func_800C9A00.c.o(.rodata)
        build/asm/disc1/BA234.s.o(.rodata)
        build/src/func_800C9B3C.c.o(.rodata)
        build/asm/disc1/BA368.s.o(.rodata)
        build/src/func_800C9C00.c.o(.rodata)
        build/src/func_800C9C10.c.o(.rodata)
        build/src/func_800C9C18.c.o(.rodata)
        build/asm/disc1/BA420.s.o(.rodata)
        ...
        build/src/func_800CBBBC.c.o(.rodata)
        build/asm/disc1/BC3F0.s.o(.rodata)
        build/src/func_800CBEE0.c.o(.rodata)
        build/asm/disc1/BC70C.s.o(.rodata)
        build/src/func_800CBFA4.c.o(.rodata)
        build/src/func_800CBFB4.c.o(.rodata)
        build/src/func_800CBFBC.c.o(.rodata)
        build/asm/disc1/BC7C4.s.o(.rodata)
        build/src/func_800CCEBC.c.o(.rodata)
        build/asm/disc1/BD6E8.s.o(.rodata)
        build/src/func_800CCF80.c.o(.rodata)
        build/src/func_800CCF90.c.o(.rodata)
        build/src/func_800CCF98.c.o(.rodata)
        build/asm/disc1/BD7A0.s.o(.rodata)
        ...
        build/src/func_800CD89C.c.o(.rodata)
        build/asm/disc1/BE0C8.s.o(.rodata)
        build/src/func_800CD960.c.o(.rodata)
        build/src/func_800CD970.c.o(.rodata)
        build/src/func_800CD978.c.o(.rodata)
        build/asm/disc1/BE180.s.o(.rodata)
        ...
        build/src/func_800CE118.c.o(.rodata)
        build/asm/disc1/BE944.s.o(.rodata)
        build/src/func_800CE1DC.c.o(.rodata)
        build/src/func_800CE1EC.c.o(.rodata)
        build/src/func_800CE1F4.c.o(.rodata)
        build/asm/disc1/BE9FC.s.o(.rodata)
        build/src/func_800CE3AC.c.o(.rodata)
        build/asm/disc1/BEBB4.s.o(.rodata)
        build/src/func_800CE464.c.o(.rodata)
        build/src/func_800CE470.c.o(.rodata)
        build/asm/disc1/BEC9C.s.o(.rodata)
        build/src/func_800CE870.c.o(.rodata)
        build/asm/disc1/BF0F0.s.o(.rodata)
        ...
        build/src/func_80012700.c.o(.bss)
        ...
        build/src/func_80017EC4.c.o(.bss)
        ...
        build/src/func_800182A0.c.o(.bss)
        build/src/func_800182C0.c.o(.bss)
        build/src/func_800182E0.c.o(.bss)
        build/asm/disc1/8B00.s.o(.bss)
        build/src/func_80018B00.c.o(.bss)
        build/asm/disc1/9330.s.o(.bss)
        build/src/func_80018B68.c.o(.bss)
        build/asm/disc1/9398.s.o(.bss)
        build/src/func_80018BC8.c.o(.bss)
        build/src/func_80018BEC.c.o(.bss)
        build/asm/disc1/9410.s.o(.bss)
        build/src/func_80018C58.c.o(.bss)
        ...
        build/src/func_80018E58.c.o(.bss)
        build/asm/disc1/9684.s.o(.bss)
        build/src/func_80018EB4.c.o(.bss)
        build/src/func_80018EE0.c.o(.bss)
        build/src/func_80018F0C.c.o(.bss)
        build/src/func_80018F54.c.o(.bss)
        build/asm/disc1/9774.s.o(.bss)
        ...
        build/src/func_80019484.c.o(.bss)
        build/asm/disc1/9CB0.s.o(.bss)
        build/src/func_800197D0.c.o(.bss)
        build/src/func_800197F0.c.o(.bss)
        build/asm/disc1/A010.s.o(.bss)
        ...
        build/src/func_80030640.c.o(.bss)
        build/asm/disc1/20EE0.s.o(.bss)
        build/src/func_80033A20.c.o(.bss)
        build/src/func_80033A2C.c.o(.bss)
        build/asm/disc1/24240.s.o(.bss)
        build/src/func_800363F4.c.o(.bss)
        build/asm/disc1/26C48.s.o(.bss)
        build/src/func_80036E34.c.o(.bss)
        build/src/func_80036E58.c.o(.bss)
        build/asm/disc1/2767C.s.o(.bss)
        build/src/func_800370A8.c.o(.bss)
        build/asm/disc1/278BC.s.o(.bss)
        build/src/func_800370DC.c.o(.bss)
        build/src/func_80037140.c.o(.bss)
        build/src/func_800371A4.c.o(.bss)
        build/asm/disc1/279B0.s.o(.bss)
        build/src/func_80037454.c.o(.bss)
        build/asm/disc1/27C6C.s.o(.bss)
        build/src/func_80037548.c.o(.bss)
        ...
        build/src/func_80039970.c.o(.bss)
        build/asm/disc1/2A19C.s.o(.bss)
        ...
        build/src/func_8003E0D0.c.o(.bss)
        build/asm/disc1/2E8FC.s.o(.bss)
        build/src/func_8003E610.c.o(.bss)
        build/src/func_8003E680.c.o(.bss)
        build/asm/disc1/2EF54.s.o(.bss)
        ...
        build/src/func_800471BC.c.o(.bss)
        build/asm/disc1/379E4.s.o(.bss)
        build/src/func_8004732C.c.o(.bss)
        build/asm/disc1/37B54.s.o(.bss)
        build/src/func_800474A8.c.o(.bss)
        build/asm/disc1/37CD0.s.o(.bss)
        build/src/func_8004B534.c.o(.bss)
        build/src/func_8004B55C.c.o(.bss)
        build/asm/disc1/3BD84.s.o(.bss)
        build/src/func_8004BF08.c.o(.bss)
        build/asm/disc1/3C740.s.o(.bss)
        ...
        build/src/func_8004D4A0.c.o(.bss)
        build/asm/disc1/3DCC4.s.o(.bss)
        ...
        build/src/func_8004EF30.c.o(.bss)
        build/asm/disc1/3F758.s.o(.bss)
        build/src/func_8004F2E4.c.o(.bss)
        build/asm/disc1/3FB0C.s.o(.bss)
        build/src/func_8004F448.c.o(.bss)
        build/asm/disc1/3FC64.s.o(.bss)
        build/src/func_8004F808.c.o(.bss)
        build/asm/disc1/40038.s.o(.bss)
        build/src/func_8004F950.c.o(.bss)
        build/src/func_8004F978.c.o(.bss)
        build/asm/disc1/401A0.s.o(.bss)
        build/src/func_8004FF30.c.o(.bss)
        build/src/func_8004FF58.c.o(.bss)
        build/src/func_8004FF80.c.o(.bss)
        build/src/func_8004FFA8.c.o(.bss)
        build/src/func_8004FFD0.c.o(.bss)
        build/src/func_8004FFF8.c.o(.bss)
        build/src/func_80050020.c.o(.bss)
        build/src/func_80050038.c.o(.bss)
        build/src/func_80050060.c.o(.bss)
        build/src/func_80050088.c.o(.bss)
        build/asm/disc1/408A8.s.o(.bss)
        build/src/func_80050204.c.o(.bss)
        build/asm/disc1/40A2C.s.o(.bss)
        build/src/func_80050260.c.o(.bss)
        build/asm/disc1/40A80.s.o(.bss)
        build/src/func_800506E8.c.o(.bss)
        build/src/func_80050708.c.o(.bss)
        build/src/func_80050728.c.o(.bss)
        build/asm/disc1/40F48.s.o(.bss)
        build/src/func_80050BE8.c.o(.bss)
        build/asm/disc1/41408.s.o(.bss)
        build/src/func_80050C50.c.o(.bss)
        build/asm/disc1/41470.s.o(.bss)
        build/src/func_80050CF8.c.o(.bss)
        build/src/func_80050D18.c.o(.bss)
        build/asm/disc1/41520.s.o(.bss)
        build/src/func_80051060.c.o(.bss)
        ...
        build/src/func_8005184C.c.o(.bss)
        build/src/func_8005186C.c.o(.bss)
        build/asm/disc1/420A8.s.o(.bss)
        ...
        build/src/func_80052534.c.o(.bss)
        build/src/func_80052558.c.o(.bss)
        build/src/func_8005257C.c.o(.bss)
        build/asm/disc1/42D94.s.o(.bss)
        build/src/func_80052790.c.o(.bss)
        build/src/func_800527B4.c.o(.bss)
        build/src/func_800527C0.c.o(.bss)
        build/asm/disc1/42FC8.s.o(.bss)
        build/src/func_8005288C.c.o(.bss)
        build/asm/disc1/43094.s.o(.bss)
        ...
        build/src/func_80055FB4.c.o(.bss)
        build/asm/disc1/467E0.s.o(.bss)
        ...
        build/src/func_8005BEE8.c.o(.bss)
        build/asm/disc1/4C708.s.o(.bss)
        build/src/func_8005C488.c.o(.bss)
        build/asm/disc1/4CC98.s.o(.bss)
        build/src/func_8005D970.c.o(.bss)
        build/asm/disc1/4E194.s.o(.bss)
        build/src/func_8005DADC.c.o(.bss)
        build/asm/disc1/4E2FC.s.o(.bss)
        ...
        build/src/func_8005E8A4.c.o(.bss)
        build/asm/disc1/4F0C4.s.o(.bss)
        build/src/func_8005E968.c.o(.bss)
        build/asm/disc1/4F188.s.o(.bss)
        build/src/func_8005EB58.c.o(.bss)
        build/asm/disc1/4F364.s.o(.bss)
        build/src/func_8005EEC8.c.o(.bss)
        build/asm/disc1/4F6D4.s.o(.bss)
        build/src/func_8005F594.c.o(.bss)
        build/asm/disc1/4FDB8.s.o(.bss)
        ...
        build/src/func_80062F1C.c.o(.bss)
        build/asm/disc1/5373C.s.o(.bss)
        ...
        build/src/func_80064C30.c.o(.bss)
        build/asm/disc1/55454.s.o(.bss)
        build/src/func_80064E90.c.o(.bss)
        build/asm/disc1/556B4.s.o(.bss)
        build/src/func_800653B8.c.o(.bss)
        build/asm/disc1/55C00.s.o(.bss)
        build/src/func_8006A5BC.c.o(.bss)
        build/src/func_8006A64C.c.o(.bss)
        build/src/func_8006A674.c.o(.bss)
        build/src/func_8006A8D4.c.o(.bss)
        build/asm/disc1/5B1E4.s.o(.bss)
        build/src/func_8006DB48.c.o(.bss)
        build/asm/disc1/5E39C.s.o(.bss)
        ...
        build/src/func_800749D8.c.o(.bss)
        ...
        build/src/func_80077A64.c.o(.bss)
        build/asm/disc1/682A0.s.o(.bss)
        build/src/func_80077AA4.c.o(.bss)
        build/asm/disc1/682BC.s.o(.bss)
        build/src/func_80077B04.c.o(.bss)
        build/asm/disc1/6832C.s.o(.bss)
        build/src/func_80077B34.c.o(.bss)
        build/asm/disc1/6835C.s.o(.bss)
        ...
        build/src/func_80077CB4.c.o(.bss)
        build/asm/disc1/684EC.s.o(.bss)
        ...
        build/src/func_8007A88C.c.o(.bss)
        build/asm/disc1/6B0AC.s.o(.bss)
        build/src/func_8007A8EC.c.o(.bss)
        build/asm/disc1/6B110.s.o(.bss)
        build/src/func_8007C130.c.o(.bss)
        build/asm/disc1/6C93C.s.o(.bss)
        build/src/func_8007C544.c.o(.bss)
        build/asm/disc1/6CD60.s.o(.bss)
        build/src/func_8007DD14.c.o(.bss)
        build/asm/disc1/6E538.s.o(.bss)
        ...
        build/src/func_8007F788.c.o(.bss)
        build/src/func_8007F7A8.c.o(.bss)
        build/asm/disc1/6FFC8.s.o(.bss)
        ...
        build/src/func_8007FC64.c.o(.bss)
        build/src/func_8007FC88.c.o(.bss)
        ...
        build/src/func_80080B04.c.o(.bss)
        build/asm/disc1/71324.s.o(.bss)
        ...
        build/src/func_800813E8.c.o(.bss)
        build/asm/disc1/71C08.s.o(.bss)
        build/src/func_800816F4.c.o(.bss)
        build/asm/disc1/71F14.s.o(.bss)
        build/src/func_800822AC.c.o(.bss)
        build/asm/disc1/72ABC.s.o(.bss)
        build/src/func_800824F0.c.o(.bss)
        build/asm/disc1/72D14.s.o(.bss)
        build/src/func_80082534.c.o(.bss)
        build/asm/disc1/72D54.s.o(.bss)
        ...
        build/src/func_80083C20.c.o(.bss)
        build/asm/disc1/7443C.s.o(.bss)
        build/src/func_80083E50.c.o(.bss)
        build/src/func_80083E70.c.o(.bss)
        build/src/func_80083E84.c.o(.bss)
        build/src/func_80083EA4.c.o(.bss)
        build/src/func_80083EC4.c.o(.bss)
        build/src/func_80083EE4.c.o(.bss)
        build/asm/disc1/746F8.s.o(.bss)
        build/src/func_800847A0.c.o(.bss)
        build/asm/disc1/74FB0.s.o(.bss)
        build/src/func_80084FC4.c.o(.bss)
        build/asm/disc1/757E4.s.o(.bss)
        build/src/func_80085084.c.o(.bss)
        build/asm/disc1/75898.s.o(.bss)
        build/src/func_80085728.c.o(.bss)
        build/asm/disc1/75F44.s.o(.bss)
        build/src/func_80085DC4.c.o(.bss)
        build/asm/disc1/765E8.s.o(.bss)
        ...
        build/src/func_8008777C.c.o(.bss)
        build/asm/disc1/77F98.s.o(.bss)
        build/src/func_800877BC.c.o(.bss)
        build/src/func_800877D4.c.o(.bss)
        build/src/func_800877F0.c.o(.bss)
        build/asm/disc1/7800C.s.o(.bss)
        build/src/func_8008788C.c.o(.bss)
        build/src/func_800878C0.c.o(.bss)
        build/asm/disc1/780F0.s.o(.bss)
        ...
        build/src/func_8009059C.c.o(.bss)
        build/src/func_800905C4.c.o(.bss)
        ...
        build/src/func_8009068C.c.o(.bss)
        ...
        build/src/func_800C2AF0.c.o(.bss)
        build/asm/disc1/B3310.s.o(.bss)
        build/src/func_800C2B40.c.o(.bss)
        build/src/func_800C2B50.c.o(.bss)
        build/asm/disc1/B3368.s.o(.bss)
        build/src/func_800C6EC0.c.o(.bss)
        build/src/func_800C6ED8.c.o(.bss)
        build/asm/disc1/B76E8.s.o(.bss)
        build/src/func_800C7D00.c.o(.bss)
        build/asm/disc1/B852C.s.o(.bss)
        ...
        build/src/func_800C8C4C.c.o(.bss)
        build/asm/disc1/B9480.s.o(.bss)
        build/src/func_800C8E44.c.o(.bss)
        build/asm/disc1/B9670.s.o(.bss)
        ...
        build/src/func_800C9A00.c.o(.bss)
        build/asm/disc1/BA234.s.o(.bss)
        build/src/func_800C9B3C.c.o(.bss)
        build/asm/disc1/BA368.s.o(.bss)
        build/src/func_800C9C00.c.o(.bss)
        build/src/func_800C9C10.c.o(.bss)
        build/src/func_800C9C18.c.o(.bss)
        build/asm/disc1/BA420.s.o(.bss)
        ...
        build/src/func_800CA6D4.c.o(.bss)
        build/asm/disc1/BAF00.s.o(.bss)
        build/src/func_800CA798.c.o(.bss)
        build/src/func_800CA7A8.c.o(.bss)
        build/src/func_800CA7B0.c.o(.bss)
        build/asm/disc1/BAFB8.s.o(.bss)
        build/src/func_800CACD4.c.o(.bss)
        build/asm/disc1/BB4DC.s.o(.bss)
        build/src/func_800CBB24.c.o(.bss)
        build/asm/disc1/BC330.s.o(.bss)
        build/src/func_800CBBBC.c.o(.bss)
        build/asm/disc1/BC3F0.s.o(.bss)
        build/src/func_800CBEE0.c.o(.bss)
        build/asm/disc1/BC70C.s.o(.bss)
        build/src/func_800CBFA4.c.o(.bss)
        build/src/func_800CBFB4.c.o(.bss)
        build/src/func_800CBFBC.c.o(.bss)
        build/asm/disc1/BC7C4.s.o(.bss)
        build/src/func_800CCEBC.c.o(.bss)
        build/asm/disc1/BD6E8.s.o(.bss)
        build/src/func_800CCF80.c.o(.bss)
        build/src/func_800CCF90.c.o(.bss)
        build/src/func_800CCF98.c.o(.bss)
        build/asm/disc1/BD7A0.s.o(.bss)
        ...
        build/src/func_800CD89C.c.o(.bss)
        build/asm/disc1/BE0C8.s.o(.bss)
        build/src/func_800CD960.c.o(.bss)
        build/src/func_800CD970.c.o(.bss)
        build/src/func_800CD978.c.o(.bss)
        build/asm/disc1/BE180.s.o(.bss)
        build/src/func_800CDD04.c.o(.bss)
        build/asm/disc1/BE50C.s.o(.bss)
        build/src/func_800CDF40.c.o(.bss)
        build/asm/disc1/BE74C.s.o(.bss)
        build/src/func_800CE118.c.o(.bss)
        build/asm/disc1/BE944.s.o(.bss)
        build/src/func_800CE1DC.c.o(.bss)
        build/src/func_800CE1EC.c.o(.bss)
        build/src/func_800CE1F4.c.o(.bss)
        build/asm/disc1/BE9FC.s.o(.bss)
        build/src/func_800CE3AC.c.o(.bss)
        build/asm/disc1/BEBB4.s.o(.bss)
        build/src/func_800CE464.c.o(.bss)
        build/src/func_800CE470.c.o(.bss)
        build/asm/disc1/BEC9C.s.o(.bss)
        build/src/func_800CE870.c.o(.bss)
        build/asm/disc1/BF0F0.s.o(.bss)
...
leaf19484 = slice(0x9C84, 0x9CB0)
leaf197d0 = slice(0x9FD0, 0x9FF0)
leaf197f0 = slice(0x9FF0, 0xA010)
leaf2f970 = slice(0x20170, 0x201CC)
leaf2f9cc = slice(0x201CC, 0x20210)
leaf38d0c = slice(0x2950C, 0x2951C)
leaf38d1c = slice(0x2951C, 0x29548)
leaf38d48 = slice(0x29548, 0x29574)
leaf39970 = slice(0x2A170, 0x2A19C)
...
leaf3e680 = slice(0x2EE80, 0x2EF54)
...
leaf36e34 = slice(0x27634, 0x27658)
leaf36e58 = slice(0x27658, 0x2767C)
...
leaf506e8 = slice(0x40EE8, 0x40F08)
leaf50708 = slice(0x40F08, 0x40F28)
leaf50728 = slice(0x40F28, 0x40F48)
leaf50be8 = slice(0x413E8, 0x41408)
leaf50c50 = slice(0x41450, 0x41470)
leaf50cf8 = slice(0x414F8, 0x41518)
leaf50d18 = slice(0x41518, 0x41520)
leaf51060 = slice(0x41860, 0x41884)
leaf51834 = slice(0x42034, 0x4204C)
leaf5184c = slice(0x4204C, 0x4206C)
leaf5186c = slice(0x4206C, 0x420A8)
leaf51e48 = slice(0x42648, 0x42658)
leaf52514 = slice(0x42D14, 0x42D24)
leaf52524 = slice(0x42D24, 0x42D34)
leaf52534 = slice(0x42D34, 0x42D58)
leaf52558 = slice(0x42D58, 0x42D7C)
leaf5257c = slice(0x42D7C, 0x42D94)
leaf52790 = slice(0x42F90, 0x42FB4)
...
leaf5f594 = slice(0x4FD94, 0x4FDB8)
leaf64e90 = slice(0x55690, 0x556B4)
leaf7a8ec = slice(0x6B0EC, 0x6B110)
leaf62f1c = slice(0x5371C, 0x5373C)
leaf63158 = slice(0x53958, 0x53998)
leaf6346c = slice(0x53C6C, 0x53CD4)
leaf64c30 = slice(0x55430, 0x55454)
leaf6a5bc = slice(0x5ADBC, 0x5AE4C)
leaf6a64c = slice(0x5AE4C, 0x5AE74)
leaf6a674 = slice(0x5AE74, 0x5B0D4)
leaf6a8d4 = slice(0x5B0D4, 0x5B1E4)
leaf6e834 = slice(0x5F034, 0x5F1A0)
leaf6e9a0 = slice(0x5F1A0, 0x5F3D4)
...
leaf749d8 = slice(0x651D8, 0x65214)
leaf74a14 = slice(0x65214, 0x65228)
leaf74a28 = slice(0x65228, 0x65238)
leaf74cb8 = slice(0x654B8, 0x654C8)
leaf84fc4 = slice(0x757C4, 0x757E4)
leaf7633c = slice(0x66B3C, 0x66B54)
leaf77a64 = slice(0x68264, 0x682A0)
leaf77cb4 = slice(0x684B4, 0x684EC)
...
leaf7fc64 = slice(0x70464, 0x70488)
leaf7fc88 = slice(0x70488, 0x704AC)
...
leaf80b04 = slice(0x71304, 0x71324)
leaf80cc8 = slice(0x714C8, 0x714DC)
leaf81254 = slice(0x71A54, 0x71A68)
leaf812f4 = slice(0x71AF4, 0x71B10)
leaf813e8 = slice(0x71BE8, 0x71C08)
leaf816f4 = slice(0x71EF4, 0x71F14)
leaf822ac = slice(0x72AAC, 0x72ABC)
leaf824f0 = slice(0x72CF0, 0x72D14)
leaf82534 = slice(0x72D34, 0x72D54)
...
leaf8788c = slice(0x7808C, 0x780C0)
leaf878c0 = slice(0x780C0, 0x780F0)
...
leaf9059c = slice(0x80D9C, 0x80DC4)
leaf905c4 = slice(0x80DC4, 0x80DEC)
...
leaf9068c = slice(0x80E8C, 0x80EB4)
...
print(f"  probe file 0x9C84 (19484): cand={cand[leaf19484].hex()} orig={orig[leaf19484].hex()}")
print(f"  probe file 0x9FD0 (197D0): cand={cand[leaf197d0].hex()} orig={orig[leaf197d0].hex()}")
print(f"  volume file 0x2F00 (12700): cand={cand[leaf12700].hex()} orig={orig[leaf12700].hex()}")
print(f"  volume file 0x9FF0 (197F0): cand={cand[leaf197f0].hex()} orig={orig[leaf197f0].hex()}")
print(f"  volume file 0x20170 (2F970): cand={cand[leaf2f970].hex()} orig={orig[leaf2f970].hex()}")
print(f"  volume file 0x201CC (2F9CC): cand={cand[leaf2f9cc].hex()} orig={orig[leaf2f9cc].hex()}")
...
print(f"  tier2 file 0x2A170 (39970): cand={cand[leaf39970].hex()} orig={orig[leaf39970].hex()}")
...
leaf4bf08 = slice(0x3C708, 0x3C740)
leaf471bc = slice(0x379BC, 0x379E4)
leaf4732c = slice(0x37B2C, 0x37B54)
leaf474a8 = slice(0x37CA8, 0x37CD0)
leaf4b534 = slice(0x3BD34, 0x3BD5C)
leaf4b55c = slice(0x3BD5C, 0x3BD84)
leaf4ef30 = slice(0x3F730, 0x3F758)
leaf4f2e4 = slice(0x3FAE4, 0x3FB0C)
leaf4f950 = slice(0x40150, 0x40178)
leaf4f978 = slice(0x40178, 0x401A0)
leaf4ff30 = slice(0x40730, 0x40758)
leaf4ff58 = slice(0x40758, 0x40780)
leaf4ff80 = slice(0x40780, 0x407A8)
leaf4ffa8 = slice(0x407A8, 0x407D0)
leaf4ffd0 = slice(0x407D0, 0x407F8)
leaf4fff8 = slice(0x407F8, 0x40820)
leaf50038 = slice(0x40838, 0x40860)
leaf50060 = slice(0x40860, 0x40888)
leaf50204 = slice(0x40A04, 0x40A2C)
...
print(f"  tier2 file 0x379BC (471BC): cand={cand[leaf471bc].hex()} orig={orig[leaf471bc].hex()}")
print(f"  tier2 file 0x37B2C (4732C): cand={cand[leaf4732c].hex()} orig={orig[leaf4732c].hex()}")
print(f"  tier2 file 0x37CA8 (474A8): cand={cand[leaf474a8].hex()} orig={orig[leaf474a8].hex()}")
print(f"  tier2 file 0x3BD34 (4B534): cand={cand[leaf4b534].hex()} orig={orig[leaf4b534].hex()}")
print(f"  tier2 file 0x3BD5C (4B55C): cand={cand[leaf4b55c].hex()} orig={orig[leaf4b55c].hex()}")
print(f"  tier2 file 0x3F730 (4EF30): cand={cand[leaf4ef30].hex()} orig={orig[leaf4ef30].hex()}")
print(f"  tier2 file 0x3FAE4 (4F2E4): cand={cand[leaf4f2e4].hex()} orig={orig[leaf4f2e4].hex()}")
print(f"  tier2 file 0x40150 (4F950): cand={cand[leaf4f950].hex()} orig={orig[leaf4f950].hex()}")
print(f"  tier2 file 0x40178 (4F978): cand={cand[leaf4f978].hex()} orig={orig[leaf4f978].hex()}")
print(f"  tier2 file 0x40730 (4FF30): cand={cand[leaf4ff30].hex()} orig={orig[leaf4ff30].hex()}")
print(f"  tier2 file 0x40758 (4FF58): cand={cand[leaf4ff58].hex()} orig={orig[leaf4ff58].hex()}")
print(f"  tier2 file 0x40780 (4FF80): cand={cand[leaf4ff80].hex()} orig={orig[leaf4ff80].hex()}")
print(f"  tier2 file 0x407A8 (4FFA8): cand={cand[leaf4ffa8].hex()} orig={orig[leaf4ffa8].hex()}")
print(f"  tier2 file 0x407D0 (4FFD0): cand={cand[leaf4ffd0].hex()} orig={orig[leaf4ffd0].hex()}")
print(f"  tier2 file 0x407F8 (4FFF8): cand={cand[leaf4fff8].hex()} orig={orig[leaf4fff8].hex()}")
print(f"  tier2 file 0x40838 (50038): cand={cand[leaf50038].hex()} orig={orig[leaf50038].hex()}")
print(f"  tier2 file 0x40860 (50060): cand={cand[leaf50060].hex()} orig={orig[leaf50060].hex()}")
print(f"  tier2 file 0x40A04 (50204): cand={cand[leaf50204].hex()} orig={orig[leaf50204].hex()}")
...
print(f"  tier2 file 0x27634 (36E34): cand={cand[leaf36e34].hex()} orig={orig[leaf36e34].hex()}")
print(f"  tier2 file 0x27658 (36E58): cand={cand[leaf36e58].hex()} orig={orig[leaf36e58].hex()}")
...
print(f"  tier2 file 0x40EE8 (506E8): cand={cand[leaf506e8].hex()} orig={orig[leaf506e8].hex()}")
print(f"  tier2 file 0x40F08 (50708): cand={cand[leaf50708].hex()} orig={orig[leaf50708].hex()}")
print(f"  tier2 file 0x40F28 (50728): cand={cand[leaf50728].hex()} orig={orig[leaf50728].hex()}")
print(f"  tier2 file 0x413E8 (50BE8): cand={cand[leaf50be8].hex()} orig={orig[leaf50be8].hex()}")
print(f"  tier2 file 0x41450 (50C50): cand={cand[leaf50c50].hex()} orig={orig[leaf50c50].hex()}")
print(f"  tier2 file 0x414F8 (50CF8): cand={cand[leaf50cf8].hex()} orig={orig[leaf50cf8].hex()}")
print(f"  probe file 0x41518 (50D18): cand={cand[leaf50d18].hex()} orig={orig[leaf50d18].hex()}")
print(f"  tier2 file 0x41860 (51060): cand={cand[leaf51060].hex()} orig={orig[leaf51060].hex()}")
...
print(f"  volume file 0x4206C (5186C): cand={cand[leaf5186c].hex()} orig={orig[leaf5186c].hex()}")
...
print(f"  tier2 file 0x42D34 (52534): cand={cand[leaf52534].hex()} orig={orig[leaf52534].hex()}")
print(f"  tier2 file 0x42D58 (52558): cand={cand[leaf52558].hex()} orig={orig[leaf52558].hex()}")
print(f"  probe file 0x42D7C (5257C): cand={cand[leaf5257c].hex()} orig={orig[leaf5257c].hex()}")
print(f"  tier2 file 0x42F90 (52790): cand={cand[leaf52790].hex()} orig={orig[leaf52790].hex()}")
...
print(f"  tier2 file 0x4FD94 (5F594): cand={cand[leaf5f594].hex()} orig={orig[leaf5f594].hex()}")
print(f"  tier2 file 0x55690 (64E90): cand={cand[leaf64e90].hex()} orig={orig[leaf64e90].hex()}")
print(f"  tier2 file 0x6B0EC (7A8EC): cand={cand[leaf7a8ec].hex()} orig={orig[leaf7a8ec].hex()}")
print(f"  tier2 file 0x5371C (62F1C): cand={cand[leaf62f1c].hex()} orig={orig[leaf62f1c].hex()}")
...
print(f"  tier2 file 0x55430 (64C30): cand={cand[leaf64c30].hex()} orig={orig[leaf64c30].hex()}")
...
print(f"  probe file 0x5B0D4 (6A8D4): cand={cand[leaf6a8d4].hex()} orig={orig[leaf6a8d4].hex()}")
print(f"  probe file 0x5F034 (6E834): cand={cand[leaf6e834].hex()} orig={orig[leaf6e834].hex()}")
print(f"  probe file 0x5F1A0 (6E9A0): cand={cand[leaf6e9a0].hex()} orig={orig[leaf6e9a0].hex()}")
...
print(f"  volume file 0x651D8 (749D8): cand={cand[leaf749d8].hex()} orig={orig[leaf749d8].hex()}")
...
print(f"  tier2 file 0x757C4 (84FC4): cand={cand[leaf84fc4].hex()} orig={orig[leaf84fc4].hex()}")
print(f"  probe file 0x66B3C (7633C): cand={cand[leaf7633c].hex()} orig={orig[leaf7633c].hex()}")
print(f"  volume file 0x68264 (77A64): cand={cand[leaf77a64].hex()} orig={orig[leaf77a64].hex()}")
print(f"  volume file 0x684B4 (77CB4): cand={cand[leaf77cb4].hex()} orig={orig[leaf77cb4].hex()}")
...
print(f"  tier2 file 0x6B08C (7A88C): cand={cand[leaf7a88c].hex()} orig={orig[leaf7a88c].hex()}")
...
print(f"  tier2 file 0x6E514 (7DD14): cand={cand[leaf7dd14].hex()} orig={orig[leaf7dd14].hex()}")
...
print(f"  tier2 file 0x6FF88 (7F788): cand={cand[leaf7f788].hex()} orig={orig[leaf7f788].hex()}")
print(f"  probe file 0x6FFA8 (7F7A8): cand={cand[leaf7f7a8].hex()} orig={orig[leaf7f7a8].hex()}")
...
print(f"  tier2 file 0x70464 (7FC64): cand={cand[leaf7fc64].hex()} orig={orig[leaf7fc64].hex()}")
print(f"  tier2 file 0x70488 (7FC88): cand={cand[leaf7fc88].hex()} orig={orig[leaf7fc88].hex()}")
...
print(f"  tier2 file 0x71304 (80B04): cand={cand[leaf80b04].hex()} orig={orig[leaf80b04].hex()}")
...
print(f"  tier2 file 0x71BE8 (813E8): cand={cand[leaf813e8].hex()} orig={orig[leaf813e8].hex()}")
print(f"  tier2 file 0x71EF4 (816F4): cand={cand[leaf816f4].hex()} orig={orig[leaf816f4].hex()}")
print(f"  probe file 0x72AAC (822AC): cand={cand[leaf822ac].hex()} orig={orig[leaf822ac].hex()}")
print(f"  tier2 file 0x72CF0 (824F0): cand={cand[leaf824f0].hex()} orig={orig[leaf824f0].hex()}")
print(f"  tier2 file 0x72D34 (82534): cand={cand[leaf82534].hex()} orig={orig[leaf82534].hex()}")
...
print(f"  volume file 0x7808C (8788C): cand={cand[leaf8788c].hex()} orig={orig[leaf8788c].hex()}")
print(f"  volume file 0x780C0 (878C0): cand={cand[leaf878c0].hex()} orig={orig[leaf878c0].hex()}")
...
print(f"  probe file 0x80D9C (9059C): cand={cand[leaf9059c].hex()} orig={orig[leaf9059c].hex()}")
print(f"  probe file 0x80DC4 (905C4): cand={cand[leaf905c4].hex()} orig={orig[leaf905c4].hex()}")
...
print(f"  probe file 0x80E8C (9068C): cand={cand[leaf9068c].hex()} orig={orig[leaf9068c].hex()}")
...
leafc2af0 = slice(0xB32F0, 0xB3310)
leaf6 = slice(0xB3340, 0xB3350)
leafc2b50 = slice(0xB3350, 0xB3368)
print(f"  tier2 file 0xB32F0 (C2AF0): cand={cand[leafc2af0].hex()} orig={orig[leafc2af0].hex()}")
...
leafc6ec0 = slice(0xB76C0, 0xB76D8)
print(f"  tier2 file 0xB76C0 (C6EC0): cand={cand[leafc6ec0].hex()} orig={orig[leafc6ec0].hex()}")
leafc6ed8 = slice(0xB76D8, 0xB76E8)
leafc7d00 = slice(0xB8500, 0xB852C)
print(f"  tier2 file 0xB76D8 (C6ED8): cand={cand[leafc6ed8].hex()} orig={orig[leafc6ed8].hex()}")
leafc7dc4 = slice(0xB85C4, 0xB85D4)
print(f"  probe file 0xB85C4 (C7DC4): cand={cand[leafc7dc4].hex()} orig={orig[leafc7dc4].hex()}")
print(f"  tier2 file 0xB8500 (C7D00): cand={cand[leafc7d00].hex()} orig={orig[leafc7d00].hex()}")
...
leafc8c4c = slice(0xB944C, 0xB9480)
leafc8e44 = slice(0xB9644, 0xB9670)
print(f"  volume file 0xB944C (C8C4C): cand={cand[leafc8c4c].hex()} orig={orig[leafc8c4c].hex()}")
print(f"  tier2 file 0xB9644 (C8E44): cand={cand[leafc8e44].hex()} orig={orig[leafc8e44].hex()}")
...
leafc9a00 = slice(0xBA200, 0xBA234)
leafc9b3c = slice(0xBA33C, 0xBA368)
print(f"  volume file 0xBA200 (C9A00): cand={cand[leafc9a00].hex()} orig={orig[leafc9a00].hex()}")
print(f"  tier2 file 0xBA33C (C9B3C): cand={cand[leafc9b3c].hex()} orig={orig[leafc9b3c].hex()}")
...
leafca6d4 = slice(0xBAED4, 0xBAF00)
print(f"  volume file 0xBAD40 (CA540): cand={cand[leafca540].hex()} orig={orig[leafca540].hex()}")
print(f"  tier2 file 0xBAED4 (CA6D4): cand={cand[leafca6d4].hex()} orig={orig[leafca6d4].hex()}")
...
leafcbbbc = slice(0xBC3BC, 0xBC3F0)
leafcbee0 = slice(0xBC6E0, 0xBC70C)
print(f"  volume file 0xBC3BC (CBBBC): cand={cand[leafcbbbc].hex()} orig={orig[leafcbbbc].hex()}")
print(f"  tier2 file 0xBC6E0 (CBEE0): cand={cand[leafcbee0].hex()} orig={orig[leafcbee0].hex()}")
print(f"  probe file 0xBC7A4 (CBFA4): cand={cand[leafcbfa4].hex()} orig={orig[leafcbfa4].hex()}")
leafcbfb4 = slice(0xBC7B4, 0xBC7BC)
print(f"  probe file 0xBC7B4 (CBFB4): cand={cand[leafcbfb4].hex()} orig={orig[leafcbfb4].hex()}")
leafcbfbc = slice(0xBC7BC, 0xBC7C4)
leafccebc = slice(0xBD6BC, 0xBD6E8)
print(f"  probe file 0xBC7BC (CBFBC): cand={cand[leafcbfbc].hex()} orig={orig[leafcbfbc].hex()}")
print(f"  tier2 file 0xBD6BC (CCEBC): cand={cand[leafccebc].hex()} orig={orig[leafccebc].hex()}")
leafccf80 = slice(0xBD780, 0xBD790)
print(f"  probe file 0xBD780 (CCF80): cand={cand[leafccf80].hex()} orig={orig[leafccf80].hex()}")
leafccf90 = slice(0xBD790, 0xBD798)
print(f"  probe file 0xBD790 (CCF90): cand={cand[leafccf90].hex()} orig={orig[leafccf90].hex()}")
leafccf98 = slice(0xBD798, 0xBD7A0)
print(f"  probe file 0xBD798 (CCF98): cand={cand[leafccf98].hex()} orig={orig[leafccf98].hex()}")
...
leafcd89c = slice(0xBE09C, 0xBE0C8)
print(f"  tier2 file 0xBE09C (CD89C): cand={cand[leafcd89c].hex()} orig={orig[leafcd89c].hex()}")
print(f"  probe file 0xBE160 (CD960): cand={cand[leafcd960].hex()} orig={orig[leafcd960].hex()}")
leafcd970 = slice(0xBE170, 0xBE178)
print(f"  probe file 0xBE170 (CD970): cand={cand[leafcd970].hex()} orig={orig[leafcd970].hex()}")
leaf14 = slice(0xBE504, 0xBE50C)
print(f"  probe file 0xBE504 (CDD04): cand={cand[leaf14].hex()} orig={orig[leaf14].hex()}")
leafce118 = slice(0xBE918, 0xBE944)
print(f"  tier2 file 0xBE918 (CE118): cand={cand[leafce118].hex()} orig={orig[leafce118].hex()}")
leafce1dc = slice(0xBE9DC, 0xBE9EC)
print(f"  probe file 0xBE9DC (CE1DC): cand={cand[leafce1dc].hex()} orig={orig[leafce1dc].hex()}")
leafce1ec = slice(0xBE9EC, 0xBE9F4)
print(f"  probe file 0xBE9EC (CE1EC): cand={cand[leafce1ec].hex()} orig={orig[leafce1ec].hex()}")
leafce1f4 = slice(0xBE9F4, 0xBE9FC)
print(f"  probe file 0xBE9F4 (CE1F4): cand={cand[leafce1f4].hex()} orig={orig[leafce1f4].hex()}")
leaf15 = slice(0xBEBAC, 0xBEBB4)
print(f"  probe file 0xBEBAC (CE3AC): cand={cand[leaf15].hex()} orig={orig[leaf15].hex()}")
leafce470 = slice(0xBEC70, 0xBEC9C)
print(f"  volume file 0xBEC70 (CE470): cand={cand[leafce470].hex()} orig={orig[leafce470].hex()}")
leafce870 = slice(0xBF070, 0xBF0F0)
print(f"  volume file 0xBF070 (CE870): cand={cand[leafce870].hex()} orig={orig[leafce870].hex()}")
