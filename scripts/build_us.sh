...
/* Phase 5AO ROM-order link script (thirty-eight C leaves).
...
echo
echo "=== Summary ==="
echo "Assemble: OK (28 asm units)"
echo "Compile:  OK (thirty-eight C leaves with Phase 4J flags)"
...
if [[ "$cmp_ec" -eq 0 ]]; then
    ...
    echo "Matching claim: YES (thirty-eight C leaves + remaining asm)"
