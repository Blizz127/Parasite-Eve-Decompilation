#!/usr/bin/env bash
# Phase 5V: Disc 1 rebuild with nineteen C leaves
# (8F694, 8F868, 8F880, 8FCB4, 904A0, 904AC, 904B4, 904BC, 906B4, 90A0C, 90C38, 90C4C, 90C60, 90C74, 90F54, C2B40, C8268, C9260, C9EA0).
#
...
# Phase 5V file-span sizes (config subsegment edges; exclusive end).
...
# BA6A8:    0xBA6A8 → 0x1EE800 = 0x134158
...
# --- compile C leaves ---
step "Compile C leaves (nineteen C leaves total incl. func_800C2B40 / func_800C8268 / func_800C9260 / func_800C9EA0)"
# shellcheck disable=SC2086
...
/* Phase 5V ROM-order link script (nineteen C leaves).
...
echo
echo "=== Summary ==="
echo "Assemble: OK (17 asm units)"
echo "Compile:  OK (nineteen C leaves with Phase 4J flags)"
...
if [[ "$cmp_ec" -eq 0 ]]; then
    ...
    echo "Matching claim: YES (nineteen C leaves + remaining asm)"
