#!/usr/bin/env bash
# Phase 5AG: Disc 1 rebuild with twenty-nine C leaves
# (3DFC8, 50D18, 527C0, 8F694, 8F6A8, 8F868, 8F880, 8FCB4, 904A0, 904AC, 904B4, 904BC, 906B4, 90A0C, 90C38, 90C4C, 90C60, 90C74, 90F54, C2B40, C8268, C9260, C9EA0, CACD4, CD2DC, CD2E4, CD59C, CDD04, CE3AC).
#
...
# Phase 5AG file-span sizes (config subsegment edges; exclusive end).
...
# --- compile C leaves ---
step "Compile C leaves (twenty-nine C leaves total incl. func_8003DFC8 / func_80050D18 / func_800527C0 / func_8008F6A8 / func_800C2B40 / func_800C8268 / func_800C9260 / func_800C9EA0 / func_800CACD4 / func_800CD2DC / func_800CD2E4 / func_800CD59C / func_800CDD04 / func_800CE3AC)"
# shellcheck disable=SC2086
...
/* Phase 5AG ROM-order link script (twenty-nine C leaves).
...
echo
echo "=== Summary ==="
echo "Assemble: OK (24 asm units)"
echo "Compile:  OK (twenty-nine C leaves with Phase 4J flags)"
...
if [[ "$cmp_ec" -eq 0 ]]; then
    ...
    echo "Matching claim: YES (twenty-nine C leaves + remaining asm)"
