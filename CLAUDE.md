...
**Phase 5EH — 207 matching C leaves; first arg+return leaf on the era path: `-O2 -G8` preserves the double store, `addu` return-0, gp store word-exact (`func_800438C0`).**
