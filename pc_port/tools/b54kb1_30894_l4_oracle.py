...
0x80030AC4..0x80030CA0 window, boundaries, control-flow/call census, and
...
CRITICAL = {
    ...
    0x80030C98: 0x32C200FF,  # delay: j & 0xff
    0x80030C9C: 0x0000B021,  # move s6,zero; last included
    0x80030CA0: 0x93A30018,  # first excluded: L5 bank load
}
