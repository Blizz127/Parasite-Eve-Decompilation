/*
 * Phase 6E-B19 — func_8005E588: display environment setup.
 *
 ...
 *   2. Three SetDefDrawEnv calls (func_80074924) initializing DRAWENV
 *      structures at D_800A2180, D_800A21F8, D_800A21DC.
 *   3. Set flags: D_800A2210=1, D_800A2198=1, D_800A2199/9A/9B=0,
 *      D_800A2211/12/13=0.
 *   4. Two SetDefDispEnv calls (func_800749D8) at D_800A2254.
 ...
 *  10. D_8009D134 = 0.
 *
 * Classification: 1 — translated retail logic.  SDK callees func_80074924
 * and func_800749D8 are REAL.  Unresolved callees func_8005E968 and
 * func_8005F844 route through the centralized bootstrap boundary.
 */
...
#define GA_DRAWENV_C    (GA_S0_BASE - 0x18u)   /* 0x800A21DC */
#define GA_DISPENV      (GA_S0_BASE + 0x60u)   /* 0x800A2254 */
...
void func_8005E588(void)
{
    ...
    /* 2. Three SetDefDrawEnv calls — REAL SDK.
    ...
    /*    DRAWENV_C: x=0, y=224, w=320, h=224 */
    func_80074924(GA_DRAWENV_C, 0, 0xE0, 0x140, 0xE0);
    ...
    func_800749D8(GA_DISPENV, 0, 0, 0x140, 0xE0);
    func_800749D8(GA_DISPENV, 0, 0, 0x140, 0xE0);
