 ...
 * enters func_80030894. B54K-A/B1/B2/B3/B4/B5/B6 translate it through
 * exclusive address 0x800311EC (598 of 788 words), with every reached GPU
 * helper native. The first unresolved inner boundary is the next packet
 * group, named func_80030894_L9_cut.
 */
...
int func_8006AD40(void)
{
    ...
    /* B54K-A..B6: issue D_800930F0 into dest+0x14C. Do not poll — the busy
     * bits stay armed across the current 30894 L9 cut. 718D0 walks
