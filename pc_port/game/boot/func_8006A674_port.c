 ...
 */
// D_800B0CD8 is unsigned int (pe_globals.c);
...
void func_8006A674(void) {
    ...
    unsigned long cursor_fill_offset_command;
    unsigned long count_or_record_cursor;
    unsigned char *base;
    unsigned long shared_value_cursor;
    unsigned char *down_count_cursor;
    unsigned char status_flags;

    count_or_record_cursor = 0;
    base = (unsigned char *)&D_800B0CD8;
