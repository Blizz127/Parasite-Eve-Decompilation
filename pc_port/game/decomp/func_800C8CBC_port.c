/*
 * decomp-source: func_800C8CBC
 * matched VMA 0x800C8CBC  file 0xB94BC  span 0x3C bytes / 15 words
 * evidence: docs/evidence/func_800C8CBC/REPORT.md
 *
 * GENERATED by tools/analysis/gen_decomp_ports.py from src/func_800C8CBC.c — do not
