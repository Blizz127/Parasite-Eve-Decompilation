/*
 * decomp-source: func_800CBBF0
 * matched VMA 0x800CBBF0  file 0xBC3F0  span 0x3C bytes / 15 words
 * evidence: docs/evidence/func_800CBBF0/REPORT.md
 *
 * GENERATED by tools/analysis/gen_decomp_ports.py from src/func_800CBBF0.c — do not
