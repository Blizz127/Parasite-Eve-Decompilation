/*
 * decomp-source: func_8007FC54
 * matched VMA 0x8007FC54  file 0x70454  span 0x10 bytes / 4 words
 * evidence: docs/evidence/func_8007FC54/REPORT.md
 *
 * GENERATED by tools/analysis/gen_decomp_ports.py from src/func_8007FC54.c — do not
...
#define D_8009B56C PE_DECOMP_SCALAR(0x8009B56Cu, unsigned char)

/* ── verbatim matching leaf (src/func_8007FC54.c) ───────────────────────── */
