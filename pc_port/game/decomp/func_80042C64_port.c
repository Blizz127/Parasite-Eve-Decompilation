/*
 * decomp-source: func_80042C64
 * matched VMA 0x80042C64  file 0x33464  span 0x14 bytes / 5 words
 * evidence: docs/evidence/func_80042C64/REPORT.md
 *
 * GENERATED by tools/analysis/gen_decomp_ports.py from src/func_80042C64.c — do not
...
#define D_800A1834 PE_DECOMP_SCALAR(0x800A1834u, unsigned int)

/* ── verbatim matching leaf (src/func_80042C64.c) ───────────────────────── */
 ...
 */
/* shimmed by pe_guest_decomp.h: D_800A1834 */
