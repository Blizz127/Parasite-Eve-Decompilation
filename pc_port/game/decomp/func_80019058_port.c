/*
 * decomp-source: func_80019058
 * matched VMA 0x80019058  file 0x9858  span 0x8 bytes / 2 words
 * evidence: docs/evidence/func_80019058/REPORT.md
 *
 * GENERATED by tools/analysis/gen_decomp_ports.py from src/func_80019058.c — do not
...
/* ── verbatim matching leaf (src/func_80019058.c) ───────────────────────── */
