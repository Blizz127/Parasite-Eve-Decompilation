/*
 * decomp-source: func_80042C00
 * matched VMA 0x80042C00  file 0x33400  span 0x14 bytes / 5 words
 * evidence: docs/evidence/func_80042C00/REPORT.md
 *
 * GENERATED by tools/analysis/gen_decomp_ports.py from src/func_80042C00.c — do not
...
/* ── verbatim matching leaf (src/func_80042C00.c) ───────────────────────── */
