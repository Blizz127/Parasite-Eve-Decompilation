/*
 * decomp-source: func_80042C3C
 * matched VMA 0x80042C3C  file 0x3343C  span 0x14 bytes / 5 words
 * evidence: docs/evidence/func_80042C3C/REPORT.md
 *
 * GENERATED by tools/analysis/gen_decomp_ports.py from src/func_80042C3C.c — do not
...
/* ── verbatim matching leaf (src/func_80042C3C.c) ───────────────────────── */
