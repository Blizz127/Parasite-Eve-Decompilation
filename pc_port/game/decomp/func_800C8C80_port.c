/*
 * decomp-source: func_800C8C80
 * matched VMA 0x800C8C80  file 0xB9480  span 0x3C bytes / 15 words
 * evidence: docs/evidence/func_800C8C80/REPORT.md
 *
 * GENERATED by tools/analysis/gen_decomp_ports.py from src/func_800C8C80.c — do not
