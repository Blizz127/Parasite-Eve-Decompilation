...
unsigned char D_800B0DCD;       /* mount-status flag: |=1 for Disc1, |=2 for Disc2 */
int           D_800B0DD8;       /* opaque word from func_80080C48 */
unsigned char D_800B0DC6;       /* post-loop clear (by func_8006E9A0) */
