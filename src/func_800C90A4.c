/* VRAM 0x800C90A4 / file 0xB98A4 / size 0x104. */
extern unsigned char *D_8009D254;
extern unsigned char D_800E0A10[];
...
extern struct Outer *D_800E27A0;
extern void func_80078C34(unsigned char *a0, unsigned char *a1, unsigned char *a2);

void func_800C90A4(int a0, int a1, unsigned char *a2) {
    ...
    func_80078C34((unsigned char *)D_800E27A0->p + 0x260,
                  D_800E0A10 + (short)(n - 1) * 8, (unsigned char *)buf);
    *(unsigned short *)(a2 + 8) = D_800E2350 + buf[0];
    *(unsigned short *)(a2 + 0xA) = D_800E2352 + buf[1];
    op = D_800E27A0;
    *(unsigned short *)(a2 + 0xC) = D_800E2354 + buf[2];
