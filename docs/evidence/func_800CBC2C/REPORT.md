# func_800CBC2C — LINK_EXACT

- Span: file `0xBC42C` / VRAM `0x800CBC2C` / size `0x3C` (`15` words).
- Split asm: `asm/disc1/BC3F0.s`.
- Profile: `era_o2_g0` (`-O2 -G0`).
- Source: `src/func_800CBC2C.c`.
...
LD_LIBRARY_PATH=tools/mipsel-host/usr/lib/x86_64-linux-gnu \
  ...
  tools/analysis/era_leaf_match.sh src/func_800CBC2C.c 0x800CBC2C 0x3C -O2 -G0
python3 tools/analysis/era_link_check.py src/func_800CBC2C.c 0x800CBC2C 0x3C -O2 -G0
```
