...
Status: **ROOT CAUSE IDENTIFIED** + draft host fix on `dig/mdec-decode-busy` (focused `DAY2_mdec` 2 pass). No `74520` / `909B4` / admit-gate invent. Prefer retail/matched leaves. Awaiting Disc1 retest.
