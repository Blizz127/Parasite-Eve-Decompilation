...
handwritten libGTE helper `func_80079304` to SKIP.
...
below contain 1,040 still-active rows. The reconciliation adds 51 post-table
park/skip/padding dispositions and corrects the stale header arithmetic.

Total: **1091** — TIER 1 9, TIER 2 214, TIER 3 99, SKIP/suppressed 769.
