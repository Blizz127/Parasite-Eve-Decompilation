...
| next_live_va | type2 forks 0x4B/0x54; type6 0x12; type3 0x85 | RESEARCH_REQUIRED | scratch&4 / region hit / D1F4 |
...
./pc_port/build/pe-native-tests   # matching_native=774/774
```

STOP/NEXT: Type-2 `0xFB` arm is ported through
`0x6A`. Next are fork `0x4B` / `0x54`. Type-3
