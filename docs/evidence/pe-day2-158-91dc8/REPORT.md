...
Status updated: **WIRED** on `cursor/movie-autonomous-stream-6f51`.
`DispatchDmaCallback` calls `func_80191DC8()` (same return shape as `1214D4`).
`74520` unchanged. Linux suite run recorded in ACTIVE_HANDOFF.
