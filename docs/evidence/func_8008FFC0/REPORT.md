# `func_8008FFC0` — matching C leaf

Outcome: **MATCHED** on default era `-O2 -G0` (no maspsx gate) and integrated.

## Span

- File `[0x807C0,0x807E4)`, VA `[0x8008FFC0,0x8008FFE4)`, size `0x24` (9 words).

## Source (`src/func_8008FFC0.c`)
...
```text
python3 tools/analysis/try_leaf.py src/func_8008FFC0.c 0x807C0 0x24
```
