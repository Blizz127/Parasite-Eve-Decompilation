...
`634dd1b` (335-leaf base). After VOLUME-143, the matching-C count is **373**.
...
The current active universe contains **1,056** unique spans. The four-way
...
removed thirty-two Tier-2 rows by integrating `func_800C6ED8`,
...
`func_80052790`, and fixed-allocation boolean wrapper `func_8004D4A0`, leaving
1,000 active
primary rows. The
56 active spans below were added after the primary tables through campaign overlays. Thus
`1000 + 56 = 1056`; the suppressed class
remains `719 + 56 = 775`.
