...
`634dd1b` (335-leaf base). After VOLUME-138, the matching-C count is **368**.
...
The current active universe contains **1,061** unique spans. The four-way
...
removed twenty-seven Tier-2 rows by integrating `func_800C6ED8`,
