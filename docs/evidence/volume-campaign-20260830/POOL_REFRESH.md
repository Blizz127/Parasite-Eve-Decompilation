...
`634dd1b` (335-leaf base). After VOLUME-148, the matching-C count is **378**.
...
The current active universe contains **1,051** unique spans. The four-way
...
removed thirty-seven Tier-2 rows by integrating `func_800C6ED8`,
...
`func_80036E34` and adjacent initializer `func_80036E58`, leaving 995 active
primary rows. The
56 active spans below were added after the primary tables through campaign overlays. Thus
`995 + 56 = 1051`; the suppressed class
remains `719 + 56 = 775`.
