...
`634dd1b` (335-leaf base). After VOLUME-114, the matching-C count is **344**.
...
The current active universe contains **1,085** unique spans. The four-way
...
removed three Tier-2 rows by integrating `func_800C6ED8`,
`func_800C6EC0`, and `func_80050020`, leaving 1,029 active
primary rows. The 56 active spans below were added after the primary tables
through campaign overlays. Thus `1029 + 56 = 1085`; the suppressed class
remains `719 + 56 = 775`.
...
symbolic-load gate. A suppressed
