...
`634dd1b` (335-leaf base). After VOLUME-147, the matching-C count is **377**.
...
The current active universe contains **1,052** unique spans. The four-way
...
removed thirty-six Tier-2 rows by integrating `func_800C6ED8`,
