...
`634dd1b` (335-leaf base). After VOLUME-129, the matching-C count is **359**.
...
The current active universe contains **1,070** unique spans. The four-way
...
removed eighteen Tier-2 rows by integrating `func_800C6ED8`,
...
`func_80050088` on its first natural phrasing. A suppressed `func_` label is
