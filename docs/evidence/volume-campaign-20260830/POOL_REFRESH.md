...
`634dd1b` (335-leaf base). After VOLUME-146, the matching-C count is **376**.
...
The current active universe contains **1,053** unique spans. The four-way
...
removed thirty-five Tier-2 rows by integrating `func_800C6ED8`,
...
`func_8005F594`, and GP-countdown wrapper `func_8004E94C`, leaving 997 active
primary rows. The
56 active spans below were added after the primary tables through campaign overlays. Thus
`997 + 56 = 1053`; the suppressed class
remains `719 + 56 = 775`.
