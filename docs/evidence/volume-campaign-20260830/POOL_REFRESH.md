...
`634dd1b` (335-leaf base). After VOLUME-141, the matching-C count is **371**.
...
The current active universe contains **1,058** unique spans. The four-way
...
removed thirty Tier-2 rows by integrating `func_800C6ED8`,
...
`func_80052534` and signed-byte twin `func_80052558`, leaving 1,002 active
primary rows. The
56 active spans below were added after the primary tables through campaign overlays. Thus
`1002 + 56 = 1058`; the suppressed class
remains `719 + 56 = 775`.
