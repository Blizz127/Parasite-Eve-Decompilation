...
`634dd1b` (335-leaf base). After VOLUME-131, the matching-C count is **361**.
...
The current active universe contains **1,068** unique spans. The four-way
...
removed twenty Tier-2 rows by integrating `func_800C6ED8`,
...
`func_80050260`, and registered callback `func_800506E8`, leaving 1,012
active primary rows. The
56 active spans below were added after the primary tables through campaign overlays. Thus
`1012 + 56 = 1068`; the suppressed class
remains `719 + 56 = 775`.
