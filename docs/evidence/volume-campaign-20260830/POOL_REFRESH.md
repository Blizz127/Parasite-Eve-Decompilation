...
`634dd1b` (335-leaf base). After VOLUME-142, the matching-C count is **372**.
...
The current active universe contains **1,057** unique spans. The four-way
...
removed thirty-one Tier-2 rows by integrating `func_800C6ED8`,
