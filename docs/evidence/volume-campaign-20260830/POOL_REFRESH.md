...
`634dd1b` (335-leaf base). After VOLUME-132, the matching-C count is **362**.
...
The current active universe contains **1,067** unique spans. The four-way
...
removed twenty-one Tier-2 rows by integrating `func_800C6ED8`,
