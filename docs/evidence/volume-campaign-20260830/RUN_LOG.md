...
Pool: 1,093 current active spans — Tier 1 13, Tier 2 214, Tier 3 99,
SKIP/suppressed 767. Refresh evidence: `POOL_REFRESH.md`.

Consecutive bounded parks: 1. Matched leaves this campaign: 1.
