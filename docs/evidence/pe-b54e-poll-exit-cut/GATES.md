...
```text
native=574/574
asan_ubsan=574/574, zero sanitizer diagnostics (Fedora toolbox
...
`b21_bzero_oracle.py` uses `DST LEN`, not the EXE argv, and is
not in that set. B54E's own 8/8 is
`pc_port/tools/b54e_6ad40_poll_exit_oracle.py`.
