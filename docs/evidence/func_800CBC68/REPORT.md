# func_800CBC68 — LINK_EXACT

- Span: file `0xBC468` / VRAM `0x800CBC68` / size `0x3C` (`15` words).
- Split asm: `asm/disc1/BC3F0.s`.
- Profile: `era_o2_g0` (`-O2 -G0`).
- Source: `src/func_800CBC68.c`.
...
LD_LIBRARY_PATH=tools/mipsel-host/usr/lib/x86_64-linux-gnu \
  ...
  tools/analysis/era_leaf_match.sh src/func_800CBC68.c 0x800CBC68 0x3C -O2 -G0
python3 tools/analysis/era_link_check.py src/func_800CBC68.c 0x800CBC68 0x3C -O2 -G0
```
