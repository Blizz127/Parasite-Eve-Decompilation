/* Best-effort whole-function C candidate for func_8001D340 (file 0xDB40,
 * size 0x2194).  Derived from pc_port/game/boot/func_8001D340_port.c (the
 * behavioural SPEC) with the PE_Load / PE_Store accessors expanded to direct
 * typed accesses.  This is EVIDENCE, not a registered match: the YAML entry
 * stays [0xDB40, asm] until a fresh scripts/build_us.sh prints EXACT SHA-1.
 */
...
typedef int            int32_t;
typedef unsigned int   pe_addr_t;

#define PE_LoadU32(a)  (*(u32 *)(a))
#define PE_LoadU16(a)  (*(u16 *)(a))
#define PE_LoadU8(a)   (*(u8  *)(a))
#define PE_StoreU32(a,v) (*(u32 *)(a) = (u32)(v))
#define PE_StoreU16(a,v) (*(u16 *)(a) = (u16)(v))
#define PE_StoreU8(a,v)  (*(u8  *)(a) = (u8)(v))
#define D_8009D1A0 (*(u32 *)(0x8009D1A0u))
...
extern void func_8001A680_command_cut(pe_addr_t actor, unsigned int cmd);
extern void func_8006DE80(int id, int a1, int x, int y, int z);
extern void func_8006DF50(int a0, int a1, int a2, int a3, int a4);
extern void func_8006DCE4(u16 a0, unsigned int a1, int a2, int a3, int a4);
...
extern void func_80032B0C(unsigned int a0, pe_addr_t a1);
...
extern int  func_8001F814(pe_addr_t actor);
...
static void player_quad_colors(pe_addr_t first, unsigned int phase, unsigned int empty);
static void player_reset_pe_colors(unsigned int empty);
