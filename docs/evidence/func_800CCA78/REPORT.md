# func_800CCA78 — LINK_EXACT

- Span: file `0xBD278` / VRAM `0x800CCA78` / size `0x38` (14 words).
- Split asm: `asm/disc1/BC7C4.s`.
- Profile: `era_o2_g0` (`-O2 -G0`).
- Source: `src/func_800CCA78.c`.
...
LD_LIBRARY_PATH=tools/mipsel-host/usr/lib/x86_64-linux-gnu \
  ...
  tools/analysis/era_leaf_match.sh src/func_800CCA78.c 0x800CCA78 0x38 -O2 -G0
python3 tools/analysis/era_link_check.py src/func_800CCA78.c 0x800CCA78 0x38 -O2 -G0
```
...
STEP for this leaf: **`6`** (paired with `func_800CCA40`/`func_800CCA78`).
