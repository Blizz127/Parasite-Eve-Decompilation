# func_800C8CF8 — LINK_EXACT

- Span: file `0xB94F8` / VRAM `0x800C8CF8` / size `0x3C` (`15` words).
- Split asm: `asm/disc1/B9480.s`.
- Profile: `era_o2_g0` (`-O2 -G0`).
- Source: `src/func_800C8CF8.c`.
...
LD_LIBRARY_PATH=tools/mipsel-host/usr/lib/x86_64-linux-gnu \
  ...
  tools/analysis/era_leaf_match.sh src/func_800C8CF8.c 0x800C8CF8 0x3C -O2 -G0
python3 tools/analysis/era_link_check.py src/func_800C8CF8.c 0x800C8CF8 0x3C -O2 -G0
```
