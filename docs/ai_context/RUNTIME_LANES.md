...
worktrees during the B54K-F rung.
...
```text
func_80030894_L9_cut (first excluded retail instruction 0x800311EC)
...
here is the native executable's bounded headless behavior and its 940-test
...
- Native `pc_port`: capture the generic event/scheduler decision that naturally
  ...
  from `func_80030894_L9_cut` into the fixed group at `D_8009E730`.
