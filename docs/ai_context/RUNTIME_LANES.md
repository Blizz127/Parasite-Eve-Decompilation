...
authoritative grind worktree after B54K-AE.
...
Results: 987 run, 987 passed, 0 failed, 0 skipped
...
```text
func_801924F8_80192728_cut from func_801924F8
...
the real FMV file search, and the call-free movie-state setup are also complete
```
