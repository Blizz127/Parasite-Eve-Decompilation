...
through `0x12` (131E8 task fork). Next on
the continuing task is `0x6A` → `6F39C(0x75)`.
Forks then hit `0x4B` / `0x54`. Type-3 `0x85`
stays hit-gated. Type-6 `0x12` still waits
...
`matching_native=773/773`. No matching `src/` C.
