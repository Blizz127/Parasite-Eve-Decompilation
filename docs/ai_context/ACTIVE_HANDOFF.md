...
registered C leaves)"; `scripts/verify_us.sh` also PASSes (all 706 packed C
spans equal retail). Coverage: 706/4519 functions (15.62%). Remaining queue:
**1683 non-matching functions / 611,792 bytes**, ranked in
