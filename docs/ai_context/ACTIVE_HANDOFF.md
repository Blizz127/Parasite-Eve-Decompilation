...
## Phase 6E-B45 func_80087090 RUNG VERIFIED

The accepted B44 starting commit is
`592ee0e6902642f7f0bac37e0f554af02254a405` with parent
`e8258e8769f2354778a812f6a446efcafd9eba78`. B45 translates
`func_80087090` (SPU upload retry wrapper, 20 retail words) as pure
retail logic. The genuine unresolved hardware provider is
`func_800851A8` (SPU DMA upload, 0xE8 bytes), routed through the
centralized bootstrap boundary. The strict real-disc frontier advances
from `func_80087090` to `func_800851A8`.
...
| Port phase | **6E-B45 func_80087090 RUNG VERIFIED** (20 retail words, retry wrapper around func_800851A8; strict frontier advances to func_800851A8) | `build-port/pe-native-tests` (434/434 normal; fresh ASan/UBSan 434/434) |
...
| Strict mode | with Disc 1: exit 1 at `func_800851A8` from `func_80087090`; with `--bootstrap-disc`: exit 1 at `func_8007F72C` from `func_800698D4` | `--headless --strict-stubs --disc-image …` |
...
| Next frontier | `func_800851A8` from `func_80087090` (SPU DMA upload, 0xE8 bytes); also `func_80052F24` from `func_8005218C`, `func_8007F72C` from `func_800698D4` | — |
